...
(day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write(writer__4370__auto__,"day8.re-frame-10x.inlined-deps.reagent.v0v9v1.reagent.impl.template/NativeWrapper");
}));
...
goog.object.set(day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.template.prop_name_cache,cljs.core.name(k),v);
...
return (function() { 
var G__26435__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__26435 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__26436__i = 0, G__26436__a = new Array(arguments.length -  0);
while (G__26436__i < G__26436__a.length) {G__26436__a[G__26436__i] = arguments[G__26436__i + 0]; ++G__26436__i;}
  args = new cljs.core.IndexedSeq(G__26436__a,0,null);
} 
return G__26435__delegate.call(this,args);};
G__26435.cljs$lang$maxFixedArity = 0;
G__26435.cljs$lang$applyTo = (function (arglist__26439){
var args = cljs.core.seq(arglist__26439);
return G__26435__delegate(args);
});
G__26435.cljs$core$IFn$_invoke$arity$variadic = G__26435__delegate;
return G__26435;
})()
;
} else {
...
if((temp__5737__auto__ == null)){
var v = day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.util.dash_to_prop_name(k);
goog.object.set(day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.template.custom_prop_name_cache,cljs.core.name(k),v);
...
var G__26337 = o;
goog.object.set(G__26337,day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.template.cached_custom_prop_name(k),day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__26447__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__26449__i < G__26449__a.length) {G__26449__a[G__26449__i] = arguments[G__26449__i + 0]; ++G__26449__i;}
  args = new cljs.core.IndexedSeq(G__26449__a,0,null);
} 
return G__26447__delegate.call(this,args);};
G__26447.cljs$lang$maxFixedArity = 0;
G__26447.cljs$lang$applyTo = (function (arglist__26450){
var args = cljs.core.seq(arglist__26450);
return G__26447__delegate(args);
});
...
var G__26344 = props;
var G__26344__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26344,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__26344);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26344__$1,new cljs.core.Keyword(null,"class","class",-2030961996),day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__26344__$1;
}
});
...
var props__$1 = day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.template.set_id_class((function (){var G__26347 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26347,new cljs.core.Keyword(null,"class","class",-2030961996),day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__26347;
}
})(),id_class);
...
day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.template.input_node_set_value = (function day8$re_frame_10x$inlined_deps$reagent$v0v9v1$reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__26357){
var map__26358 = p__26357;
var map__26358__$1 = (((((!((map__26358 == null))))?(((((map__26358.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__26358.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__26358):map__26358);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26358__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__26372_SHARP_){
return day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.template.input_handle_change(this$,on_change,p1__26372_SHARP_);
}));
} else {
return null;
}
...
(day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.template.HiccupTag.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write(writer__4370__auto__,"day8.re-frame-10x.inlined-deps.reagent.v0v9v1.reagent.impl.template/HiccupTag");
}));
...
var vec__26378 = cljs.core.next(cljs.core.re_matches(day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26378,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26378,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26378,(2),null);
...
var temp__5739__auto___26509 = day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___26509 == null)){
} else {
var key_26510 = temp__5739__auto___26509;
(jsprops.key = key_26510);
}
...
var jsprops = (function (){var or__4126__auto__ = day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.template.convert_prop_value(((hasprops)?props:null));
...
var temp__5739__auto___26513 = day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___26513 == null)){
} else {
var key_26514 = temp__5739__auto___26513;
(jsprops.key = key_26514);
}
...
var hasprops = (((props == null)) || (cljs.core.map_QMARK_(props)));
var jsprops = (function (){var or__4126__auto__ = day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.template.convert_props(((hasprops)?props:null),parsed);
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
return ({});
...
var G__26390 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__26390) : day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.template.as_element.call(null,G__26390));
} else {
var temp__5739__auto___26515 = day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5739__auto___26515 == null)){
} else {
var key_26518 = temp__5739__auto___26515;
(jsprops.key = key_26518);
}
...
var G__26392 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__26392)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__26392)){
return x;
} else {
...
return day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__4743__auto__);
});
...
/** @this {Function} */
(day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq26393){
var G__26394 = cljs.core.first(seq26393);
var seq26393__$1 = cljs.core.next(seq26393);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26394,seq26393__$1);
}));
...
break;
default:
var G__26533 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__26533;
continue;
...
var ctx = ({});
var vec__26413 = day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.check_derefs((function (){
return day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26413,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26413,(1),null);
...
var G__26421 = (cljs.core.count(argv) - first_child);
switch (G__26421) {
case (0):
...
break;
case (1):
return module$node_modules$react$index.createElement(component,jsprops,day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null)));
