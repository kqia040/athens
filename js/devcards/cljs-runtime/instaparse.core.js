...
if(cljs.core.truth_((function (){var fexpr__57299 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__57299.cljs$core$IFn$_invoke$arity$1 ? fexpr__57299.cljs$core$IFn$_invoke$arity$1(type) : fexpr__57299.call(null,type));
})())){
} else {
...
if(cljs.core.truth_((function (){var fexpr__57300 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ebnf","ebnf",31967825),null,new cljs.core.Keyword(null,"abnf","abnf",-152462052),null], null), null);
return (fexpr__57300.cljs$core$IFn$_invoke$arity$1 ? fexpr__57300.cljs$core$IFn$_invoke$arity$1(type) : fexpr__57300.call(null,type));
})())){
} else {
...
var G__57307 = unhide;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__57307)){
return parser;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"content","content",15833224),G__57307)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tags","tags",1771418977),G__57307)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"all","all",892129742),G__57307)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__57307)].join('')));
...
var i__4737__auto___57440 = (0);
while(true){
if((i__4737__auto___57440 < len__4736__auto___57439)){
args__4742__auto__.push((arguments[i__4737__auto___57440]));

var G__57441 = (i__4737__auto___57440 + (1));
i__4737__auto___57440 = G__57441;
continue;
} else {
}
break;
...
(instaparse.core.parse.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__57313){
var map__57315 = p__57313;
...
return instaparse.gll.parse_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__57324 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__57324) : instaparse.reduction.node_builders.call(null,G__57324));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parse.cljs$lang$applyTo = (function (seq57310){
var G__57311 = cljs.core.first(seq57310);
var seq57310__$1 = cljs.core.next(seq57310);
var G__57312 = cljs.core.first(seq57310__$1);
var seq57310__$2 = cljs.core.next(seq57310__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57311,G__57312,seq57310__$2);
}));
...
var args__4742__auto__ = [];
var len__4736__auto___57448 = arguments.length;
var i__4737__auto___57449 = (0);
while(true){
if((i__4737__auto___57449 < len__4736__auto___57448)){
args__4742__auto__.push((arguments[i__4737__auto___57449]));

var G__57450 = (i__4737__auto___57449 + (1));
i__4737__auto___57449 = G__57450;
continue;
} else {
}
break;
...
(instaparse.core.parses.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__57333){
...
var parser__$1 = instaparse.core.unhide_parser(parser,unhide);
if(cljs.core.truth_(new cljs.core.Keyword(null,"total","total",1916810418).cljs$core$IFn$_invoke$arity$1(options))){
return instaparse.gll.parses_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__57342 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__57342) : instaparse.reduction.node_builders.call(null,G__57342));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parses.cljs$lang$applyTo = (function (seq57327){
var G__57328 = cljs.core.first(seq57327);
var seq57327__$1 = cljs.core.next(seq57327);
var G__57329 = cljs.core.first(seq57327__$1);
var seq57327__$2 = cljs.core.next(seq57327__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57328,G__57329,seq57327__$2);
}));
...
(instaparse.core.Parser.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k57353,else__4383__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k57353,else__4383__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__57372){
var vec__57373 = p__57372;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57373,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57373,(1),null);
...
(instaparse.core.Parser.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this57354,other57355){
var self__ = this;
var this57354__$1 = this;
return (((!((other57355 == null)))) && ((this57354__$1.constructor === other57355.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57354__$1.grammar,other57355.grammar)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57354__$1.start_production,other57355.start_production)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57354__$1.output_format,other57355.output_format)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57354__$1.__extmap,other57355.__extmap)));
}));
...
(instaparse.core.Parser.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__57352){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__57380 = cljs.core.keyword_identical_QMARK_;
var expr__57381 = k__4388__auto__;
if(cljs.core.truth_((pred__57380.cljs$core$IFn$_invoke$arity$2 ? pred__57380.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"grammar","grammar",1881328267),expr__57381) : pred__57380.call(null,new cljs.core.Keyword(null,"grammar","grammar",1881328267),expr__57381)))){
return (new instaparse.core.Parser(G__57352,self__.start_production,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__57380.cljs$core$IFn$_invoke$arity$2 ? pred__57380.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"start-production","start-production",687546537),expr__57381) : pred__57380.call(null,new cljs.core.Keyword(null,"start-production","start-production",687546537),expr__57381)))){
return (new instaparse.core.Parser(self__.grammar,G__57352,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__57380.cljs$core$IFn$_invoke$arity$2 ? pred__57380.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"output-format","output-format",-1826382676),expr__57381) : pred__57380.call(null,new cljs.core.Keyword(null,"output-format","output-format",-1826382676),expr__57381)))){
return (new instaparse.core.Parser(self__.grammar,self__.start_production,G__57352,self__.__meta,self__.__extmap,null));
} else {
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__57352),null));
}
}
}
}));
...
(instaparse.core.Parser.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__57352){
var self__ = this;
var this__4379__auto____$1 = this;
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,G__57352,self__.__extmap,self__.__hash));
}));
...
var self__ = this;
var self__ = this;
var G__57383 = (arguments.length - (1));
switch (G__57383) {
case (1):
...
(instaparse.core.Parser.prototype.apply = (function (self__,args57365){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args57365)));
}));
 ...
 */
instaparse.core.map__GT_Parser = (function instaparse$core$map__GT_Parser(G__57356){
var extmap__4419__auto__ = (function (){var G__57391 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__57356,new cljs.core.Keyword(null,"grammar","grammar",1881328267),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"start-production","start-production",687546537),new cljs.core.Keyword(null,"output-format","output-format",-1826382676)], 0));
if(cljs.core.record_QMARK_(G__57356)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__57391);
} else {
return G__57391;
}
})();
return (new instaparse.core.Parser(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(G__57356),new cljs.core.Keyword(null,"start-production","start-production",687546537).cljs$core$IFn$_invoke$arity$1(G__57356),new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(G__57356),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
...
var args__4742__auto__ = [];
var len__4736__auto___57532 = arguments.length;
var i__4737__auto___57533 = (0);
while(true){
if((i__4737__auto___57533 < len__4736__auto___57532)){
args__4742__auto__.push((arguments[i__4737__auto___57533]));

var G__57537 = (i__4737__auto___57533 + (1));
i__4737__auto___57533 = G__57537;
continue;
} else {
}
break;
...
(instaparse.core.parser.cljs$core$IFn$_invoke$arity$variadic = (function (grammar_specification,p__57399){
var map__57400 = p__57399;
...
var _STAR_case_insensitive_literals_STAR__temp_val__57420 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(options,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__57420);

try{var G__57423 = input_format;
var G__57423__$1 = (((G__57423 instanceof cljs.core.Keyword))?G__57423.fqn:null);
switch (G__57423__$1) {
case "abnf":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__57423__$1)].join('')));
...
var map__57429 = temp__5733__auto__;
var map__57429__$1 = (((((!((map__57429 == null))))?(((((map__57429.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__57429.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__57429):map__57429);
var ws_grammar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57429__$1,new cljs.core.Keyword(null,"grammar","grammar",1881328267));
var ws_start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57429__$1,new cljs.core.Keyword(null,"start-production","start-production",687546537));
...
/** @this {Function} */
(instaparse.core.parser.cljs$lang$applyTo = (function (seq57392){
var G__57393 = cljs.core.first(seq57392);
var seq57392__$1 = cljs.core.next(seq57392);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57393,seq57392__$1);
}));
