...
if(cljs.core.truth_(((cljs.core.not(hidden_QMARK_))?(function (){var G__54854 = (parser.cljs$core$IFn$_invoke$arity$1 ? parser.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"tag","tag",-1290361223)) : parser.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223)));
return (tag_set.cljs$core$IFn$_invoke$arity$1 ? tag_set.cljs$core$IFn$_invoke$arity$1(G__54854) : tag_set.call(null,G__54854));
})():false))){
...
instaparse.print.char_range__GT_str = (function instaparse$print$char_range__GT_str(p__54858){
var map__54859 = p__54858;
var map__54859__$1 = (((((!((map__54859 == null))))?(((((map__54859.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__54859.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__54859):map__54859);
var lo = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54859__$1,new cljs.core.Keyword(null,"lo","lo",-931799889));
var hi = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54859__$1,new cljs.core.Keyword(null,"hi","hi",-1821422114));
...
(instaparse.print.combinators__GT_str.cljs$core$IFn$_invoke$arity$2 = (function (p__54864,hidden_QMARK_){
...
var p = map__54865__$1;
var parser = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54865__$1,new cljs.core.Keyword(null,"parser","parser",-1543495310));
var parser1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54865__$1,new cljs.core.Keyword(null,"parser1","parser1",-439601422));
var parser2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54865__$1,new cljs.core.Keyword(null,"parser2","parser2",1013754688));
var parsers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54865__$1,new cljs.core.Keyword(null,"parsers","parsers",-804353827));
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54865__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
...
var G__54867 = tag;
var G__54867__$1 = (((G__54867 instanceof cljs.core.Keyword))?G__54867.fqn:null);
switch (G__54867__$1) {
case "epsilon":
return "\u03B5";
...
var _STAR_print_newline_STAR__orig_val__54870_54906 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__54871_54907 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__54872_54908 = true;
var _STAR_print_fn_STAR__temp_val__54873_54909 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__54872_54908);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__54873_54909);
...
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__54871_54907);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__54870_54906);
}
...
case "string-ci":
var sb__4667__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__54875_54911 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__54876_54912 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__54877_54913 = true;
var _STAR_print_fn_STAR__temp_val__54878_54914 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__54877_54913);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__54878_54914);

try{cljs.core.pr.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"string","string",-1989541586).cljs$core$IFn$_invoke$arity$1(p)], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__54876_54912);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__54875_54911);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4667__auto__);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__54867__$1)].join('')));
 ...
 */
instaparse.print.Parser__GT_str = (function instaparse$print$Parser__GT_str(p__54884){
...
var grammar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54885__$1,new cljs.core.Keyword(null,"grammar","grammar",1881328267));
var start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54885__$1,new cljs.core.Keyword(null,"start-production","start-production",687546537));
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.cons(instaparse.print.rule__GT_str(start,(grammar.cljs$core$IFn$_invoke$arity$1 ? grammar.cljs$core$IFn$_invoke$arity$1(start) : grammar.call(null,start))),(function (){var iter__4529__auto__ = (function instaparse$print$Parser__GT_str_$_iter__54887(s__54888){
return (new cljs.core.LazySeq(null,(function (){
var s__54888__$1 = s__54888;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__54888__$1);
if(temp__5735__auto__){
var s__54888__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__54888__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__54888__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__54890 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__54889 = (0);
while(true){
if((i__54889 < size__4528__auto__)){
var vec__54892 = cljs.core._nth(c__4527__auto__,i__54889);
var non_terminal = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54892,(0),null);
var parser = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54892,(1),null);
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(non_terminal,start)){
cljs.core.chunk_append(b__54890,instaparse.print.rule__GT_str(non_terminal,parser));

var G__54926 = (i__54889 + (1));
i__54889 = G__54926;
continue;
} else {
var G__54927 = (i__54889 + (1));
i__54889 = G__54927;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__54890),instaparse$print$Parser__GT_str_$_iter__54887(cljs.core.chunk_rest(s__54888__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__54890),null);
}
} else {
var vec__54895 = cljs.core.first(s__54888__$2);
var non_terminal = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54895,(0),null);
var parser = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54895,(1),null);
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(non_terminal,start)){
return cljs.core.cons(instaparse.print.rule__GT_str(non_terminal,parser),instaparse$print$Parser__GT_str_$_iter__54887(cljs.core.rest(s__54888__$2)));
} else {
var G__54929 = cljs.core.rest(s__54888__$2);
s__54888__$1 = G__54929;
continue;
}
}
} else {
