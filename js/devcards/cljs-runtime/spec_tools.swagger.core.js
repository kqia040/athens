...
spec_tools.swagger.core.accept_spec.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),(function (_,___$1,children,p__54425){
var map__54426 = p__54425;
var map__54426__$1 = (((((!((map__54426 == null))))?(((((map__54426.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__54426.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__54426):map__54426);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54426__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var in$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54426__$1,new cljs.core.Keyword(null,"in","in",-1531184865));
...
var vec__54431 = spec_tools.impl.extract_form(spec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54431,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54431,(1),null);
...
var method_cache__4621__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__4622__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__4623__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__54442 = cljs.core.get_global_hierarchy;
...
var map__54447 = spec_tools.swagger.core.transform.cljs$core$IFn$_invoke$arity$2(spec,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"in","in",-1531184865),in$,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"parameter","parameter",1978789597)], null));
...
var properties = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54447__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
var required = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54447__$1,new cljs.core.Keyword(null,"required","required",1807647006));
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p__54452){
var vec__54453 = p__54452;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54453,(0),null);
var map__54456 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54453,(1),null);
...
var method_cache__4621__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__4622__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__4623__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__54461 = cljs.core.get_global_hierarchy;
...
})(),(function (){var iter__4529__auto__ = (function spec_tools$swagger$core$iter__54464(s__54465){
return (new cljs.core.LazySeq(null,(function (){
var s__54465__$1 = s__54465;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__54465__$1);
if(temp__5735__auto__){
var s__54465__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__54465__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__54465__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__54467 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__54466 = (0);
while(true){
if((i__54466 < size__4528__auto__)){
var vec__54469 = cljs.core._nth(c__4527__auto__,i__54466);
var status = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54469,(0),null);
var response = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54469,(1),null);
cljs.core.chunk_append(b__54467,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [status,(function (){var $ = response;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__54467),spec_tools$swagger$core$iter__54464(cljs.core.chunk_rest(s__54465__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__54467),null);
}
} else {
var vec__54473 = cljs.core.first(s__54465__$2);
var status = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54473,(0),null);
var response = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54473,(1),null);
...
var $__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"schema","schema",-1582001791).cljs$core$IFn$_invoke$arity$1($))?cljs.core.update.cljs$core$IFn$_invoke$arity$4($,new cljs.core.Keyword(null,"schema","schema",-1582001791),spec_tools.swagger.core.transform,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"schema","schema",-1582001791)], null)):$);
return cljs.core.update.cljs$core$IFn$_invoke$arity$3($__$1,new cljs.core.Keyword(null,"description","description",-1428560544),cljs.core.fnil.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,""));
})()], null),spec_tools$swagger$core$iter__54464(cljs.core.rest(s__54465__$2)));
}
} else {
return null;
}
...
var new$ = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__54479){
var vec__54483 = p__54479;
var in$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54483,(0),null);
var spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54483,(1),null);
return spec_tools.swagger.core.extract_parameter.cljs$core$IFn$_invoke$arity$2(in$,spec);
}),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([v], 0));
var merged = cljs.core.vec(cljs.core.reverse(cljs.core.first(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__54486,p){
var vec__54487 = p__54486;
var ps = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54487,(0),null);
var cache = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54487,(1),null);
var acc__$1 = vec__54487;
