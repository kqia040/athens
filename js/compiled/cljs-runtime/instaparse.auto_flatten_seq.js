...
var instaparse$auto_flatten_seq$ConjFlat$conj_flat$dyn_50945 = (function (self,obj){
...
return instaparse$auto_flatten_seq$ConjFlat$conj_flat$dyn_50945(self,obj);
}
});

var instaparse$auto_flatten_seq$ConjFlat$cached_QMARK_$dyn_50946 = (function (self){
var x__4428__auto__ = (((self == null))?null:self);
...
return instaparse$auto_flatten_seq$ConjFlat$cached_QMARK_$dyn_50946(self);
}
});
...
var G__50949 = n__$1;
var G__50950 = y;
var G__50951 = cljs.core.imul(z,z);
n = G__50949;
y = G__50950;
z = G__50951;
continue;
...
var G__50952 = n__$1;
var G__50953 = cljs.core.imul(z,y);
var G__50954 = cljs.core.imul(z,z);
n = G__50952;
y = G__50953;
z = G__50954;
continue;
...
var G__50955 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(v__$1,(0));
var G__50956 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(index__$1,(0));
v__$1 = G__50955;
index__$1 = G__50956;
continue;
} else {
...
if((cljs.core.peek(index) < ((function (){var G__50689 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(v,cljs.core.pop(index));
return (instaparse.auto_flatten_seq.true_count.cljs$core$IFn$_invoke$arity$1 ? instaparse.auto_flatten_seq.true_count.cljs$core$IFn$_invoke$arity$1(G__50689) : instaparse.auto_flatten_seq.true_count.call(null,G__50689));
})() - (1)))){
...
var G__50958 = v;
var G__50959 = cljs.core.pop(index);
v = G__50958;
index = G__50959;
continue;
...
while(true){
if((!((coll__$1 == null)))){
var G__51003 = ((cljs.core.imul((31),unmixed_hash) + cljs.core.hash(cljs.core.first(coll__$1))) | (0));
var G__51004 = cljs.core.next(coll__$1);
unmixed_hash = G__51003;
coll__$1 = G__51004;
continue;
} else {
return unmixed_hash;
...
var G__51011 = (instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2 ? instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2(acc,fst) : instaparse.auto_flatten_seq.flat_vec_helper.call(null,acc,fst));
var G__51012 = cljs.core.next(v);
acc = G__51011;
v = G__51012;
continue;
} else {
var G__51013 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,fst);
var G__51014 = cljs.core.next(v);
acc = G__51013;
v = G__51014;
continue;
}
...
var instaparse$auto_flatten_seq$GetVec$get_vec$dyn_51015 = (function (self){
var x__4428__auto__ = (((self == null))?null:self);
...
return instaparse$auto_flatten_seq$GetVec$get_vec$dyn_51015(self);
}
});
...
var self__ = this;
var self__ = this;
var G__50930 = (arguments.length - (1));
switch (G__50930) {
case (1):
...
(instaparse.auto_flatten_seq.FlattenOnDemandVector.prototype.apply = (function (self__,args50868){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args50868)));
}));
