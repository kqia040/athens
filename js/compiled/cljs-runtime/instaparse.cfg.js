...
var G__53793 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(true,G__53793)){
return instaparse.combinators_source.string_ci(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(false,G__53793)){
return instaparse.combinators_source.string(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"default","default",-1987822328),G__53793)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__53793)].join('')));
...
var G__54052 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__54053 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c2);
sq = G__54052;
v = G__54053;
continue;
} else {
var G__54054 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__54055 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,c,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([c2], 0));
sq = G__54054;
v = G__54055;
continue;
}
...
break;
case "\"":
var G__54059 = cljs.core.next(sq);
var G__54060 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,"\\",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["\""], 0));
sq = G__54059;
v = G__54060;
continue;
...
break;
default:
var G__54062 = cljs.core.next(sq);
var G__54063 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c);
sq = G__54062;
v = G__54063;
continue;
...
while(true){
var G__53897 = (instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.tag.call(null,tree));
var G__53897__$1 = (((G__53897 instanceof cljs.core.Keyword))?G__53897.fqn:null);
switch (G__53897__$1) {
case "rule":
var vec__53899 = (instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.contents.call(null,tree));
var nt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53899,(0),null);
var alt_or_ord = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53899,(1),null);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1((function (){var G__53906 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(nt) : instaparse.cfg.content.call(null,nt));
return (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(G__53906) : instaparse.cfg.content.call(null,G__53906));
...
break;
case "paren":
var G__54100 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
tree = G__54100;
continue;

break;
case "hide":
return instaparse.combinators_source.hide((function (){var G__53911 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__53911) : instaparse.cfg.build_rule.call(null,G__53911));
})());
...
break;
case "opt":
return instaparse.combinators_source.opt((function (){var G__53913 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__53913) : instaparse.cfg.build_rule.call(null,G__53913));
})());

break;
case "star":
return instaparse.combinators_source.star((function (){var G__53915 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__53915) : instaparse.cfg.build_rule.call(null,G__53915));
})());

break;
case "plus":
return instaparse.combinators_source.plus((function (){var G__53917 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__53917) : instaparse.cfg.build_rule.call(null,G__53917));
})());

break;
case "look":
return instaparse.combinators_source.look((function (){var G__53919 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__53919) : instaparse.cfg.build_rule.call(null,G__53919));
})());

break;
case "neg":
return instaparse.combinators_source.neg((function (){var G__53921 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__53921) : instaparse.cfg.build_rule.call(null,G__53921));
})());
...
while(true){
var G__53927 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser);
...
case "neg":
case "rep":
var G__54117 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__54117;
continue;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__53927__$1)].join('')));
...
var valid_nts_54123 = cljs.core.set(cljs.core.keys(grammar_map));
var seq__53938_54125 = cljs.core.seq(cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(instaparse.cfg.seq_nt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.vals(grammar_map)], 0))));
var chunk__53939_54128 = null;
var count__53940_54129 = (0);
var i__53941_54130 = (0);
while(true){
if((i__53941_54130 < count__53940_54129)){
var nt_54132 = chunk__53939_54128.cljs$core$IIndexed$_nth$arity$2(null,i__53941_54130);
if(cljs.core.truth_((valid_nts_54123.cljs$core$IFn$_invoke$arity$1 ? valid_nts_54123.cljs$core$IFn$_invoke$arity$1(nt_54132) : valid_nts_54123.call(null,nt_54132)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_54132),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__54135 = seq__53938_54125;
var G__54136 = chunk__53939_54128;
var G__54137 = count__53940_54129;
var G__54138 = (i__53941_54130 + (1));
seq__53938_54125 = G__54135;
chunk__53939_54128 = G__54136;
count__53940_54129 = G__54137;
i__53941_54130 = G__54138;
continue;
} else {
var temp__5735__auto___54141 = cljs.core.seq(seq__53938_54125);
if(temp__5735__auto___54141){
var seq__53938_54144__$1 = temp__5735__auto___54141;
if(cljs.core.chunked_seq_QMARK_(seq__53938_54144__$1)){
var c__4556__auto___54145 = cljs.core.chunk_first(seq__53938_54144__$1);
var G__54146 = cljs.core.chunk_rest(seq__53938_54144__$1);
var G__54147 = c__4556__auto___54145;
var G__54148 = cljs.core.count(c__4556__auto___54145);
var G__54149 = (0);
seq__53938_54125 = G__54146;
chunk__53939_54128 = G__54147;
count__53940_54129 = G__54148;
i__53941_54130 = G__54149;
continue;
} else {
var nt_54151 = cljs.core.first(seq__53938_54144__$1);
if(cljs.core.truth_((valid_nts_54123.cljs$core$IFn$_invoke$arity$1 ? valid_nts_54123.cljs$core$IFn$_invoke$arity$1(nt_54151) : valid_nts_54123.call(null,nt_54151)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_54151),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__54158 = cljs.core.next(seq__53938_54144__$1);
var G__54159 = null;
var G__54160 = (0);
var G__54161 = (0);
seq__53938_54125 = G__54158;
chunk__53939_54128 = G__54159;
count__53940_54129 = G__54160;
i__53941_54130 = G__54161;
continue;
}
} else {
}
...
var _STAR_print_newline_STAR__orig_val__53956_54167 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__53957_54168 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__53958_54169 = true;
var _STAR_print_fn_STAR__temp_val__53959_54170 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__53958_54169);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__53959_54170);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__53957_54168);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__53956_54167);
}
...
var len__4736__auto___54195 = arguments.length;
var i__4737__auto___54198 = (0);
while(true){
if((i__4737__auto___54198 < len__4736__auto___54195)){
args__4742__auto__.push((arguments[i__4737__auto___54198]));

var G__54205 = (i__4737__auto___54198 + (1));
i__4737__auto___54198 = G__54205;
continue;
} else {
}
break;
...
(instaparse.cfg.ebnf.cljs$core$IFn$_invoke$arity$variadic = (function (spec,p__53964){
...
var opts = map__53965__$1;
var _STAR_case_insensitive_literals_STAR__orig_val__53968 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__53969 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(opts,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__53969);
...
if((rules instanceof instaparse.gll.Failure)){
return instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error parsing grammar specification:\n",(function (){var sb__4667__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__53970_54218 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__53971_54219 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__53972_54220 = true;
var _STAR_print_fn_STAR__temp_val__53973_54221 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__53972_54220);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__53973_54221);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__53971_54219);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__53970_54218);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4667__auto__);
})()], 0));
} else {
...
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__53968);
}}));

(instaparse.cfg.ebnf.cljs$lang$maxFixedArity = (1));

/** @this {Function} */
(instaparse.cfg.ebnf.cljs$lang$applyTo = (function (seq53962){
var G__53963 = cljs.core.first(seq53962);
var seq53962__$1 = cljs.core.next(seq53962);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__53963,seq53962__$1);
}));
