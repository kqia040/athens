...
var G__24974 = cljs.core.first(poshdb);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__24974__$1)].join('')));
...
var G__25053 = cljs.core.cons(pdb,path);
var G__25054 = posh.lib.db.get_parent_db(pdb);
path = G__25053;
pdb = G__25054;
continue;
} else {
...
var G__25055 = posh.lib.db.get_parent_db(poshdb);
poshdb = G__25055;
continue;
}
break;
...
var map__25013 = filters;
var map__25013__$1 = (((((!((map__25013 == null))))?(((((map__25013.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__25013.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__25013):map__25013);
var filter = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25013__$1,new cljs.core.Keyword(null,"filter","filter",-948537934));
var as_of = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25013__$1,new cljs.core.Keyword(null,"as-of","as-of",-1841962382));
var since = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25013__$1,new cljs.core.Keyword(null,"since","since",315379842));
var with$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25013__$1,new cljs.core.Keyword(null,"with","with",-1536296876));
var db__$1 = (function (){var or__4126__auto__ = db;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
var fexpr__25019 = new cljs.core.Keyword(null,"db","db",993250759).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__25019.cljs$core$IFn$_invoke$arity$1 ? fexpr__25019.cljs$core$IFn$_invoke$arity$1(conn) : fexpr__25019.call(null,conn));
}
})();
var db__$2 = (cljs.core.truth_(since)?(function (){var fexpr__25021 = new cljs.core.Keyword(null,"since","since",315379842).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__25021.cljs$core$IFn$_invoke$arity$2 ? fexpr__25021.cljs$core$IFn$_invoke$arity$2(db__$1,since) : fexpr__25021.call(null,db__$1,since));
})():db__$1);
var db__$3 = (cljs.core.truth_(as_of)?(function (){var fexpr__25026 = new cljs.core.Keyword(null,"as-of","as-of",-1841962382).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__25026.cljs$core$IFn$_invoke$arity$2 ? fexpr__25026.cljs$core$IFn$_invoke$arity$2(db__$2,as_of) : fexpr__25026.call(null,db__$2,as_of));
})():db__$2);
var db__$4 = (cljs.core.truth_(with$)?new cljs.core.Keyword(null,"db-after","db-after",-571884666).cljs$core$IFn$_invoke$arity$1((function (){var fexpr__25027 = new cljs.core.Keyword(null,"with","with",-1536296876).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__25027.cljs$core$IFn$_invoke$arity$2 ? fexpr__25027.cljs$core$IFn$_invoke$arity$2(db__$3,with$) : fexpr__25027.call(null,db__$3,with$));
})()):db__$3);
var db__$5 = (cljs.core.truth_(filter)?(function (){var G__25029 = db__$4;
var G__25030 = (((filter instanceof cljs.core.Symbol))?null:filter);
var fexpr__25028 = new cljs.core.Keyword(null,"filter","filter",-948537934).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__25028.cljs$core$IFn$_invoke$arity$2 ? fexpr__25028.cljs$core$IFn$_invoke$arity$2(G__25029,G__25030) : fexpr__25028.call(null,G__25029,G__25030));
})():db__$4);
return db__$5;
}));
...
posh.lib.db.poshdb__GT_db = (function posh$lib$db$poshdb__GT_db(p__25031,poshdb){
...
var posh_tree = map__25032__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25032__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var cache = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25032__$1,new cljs.core.Keyword(null,"cache","cache",-1237023054));
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.first(poshdb),new cljs.core.Keyword(null,"db","db",993250759))){
return posh.lib.db.db_id__GT_db(posh_tree,cljs.core.second(poshdb));
} else {
var G__25039 = (function (){var G__25041 = posh_tree;
var G__25042 = posh.lib.db.get_parent_db(poshdb);
return (posh.lib.db.poshdb__GT_db.cljs$core$IFn$_invoke$arity$2 ? posh.lib.db.poshdb__GT_db.cljs$core$IFn$_invoke$arity$2(G__25041,G__25042) : posh.lib.db.poshdb__GT_db.call(null,G__25041,G__25042));
})();
var G__25040 = posh.lib.db.make_filter_pred(new cljs.core.Keyword(null,"pass-patterns","pass-patterns",1090887263).cljs$core$IFn$_invoke$arity$1(cljs.core.get.cljs$core$IFn$_invoke$arity$2(cache,poshdb)));
var fexpr__25038 = new cljs.core.Keyword(null,"filter","filter",-948537934).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__25038.cljs$core$IFn$_invoke$arity$2 ? fexpr__25038.cljs$core$IFn$_invoke$arity$2(G__25039,G__25040) : fexpr__25038.call(null,G__25039,G__25040));
}
});
