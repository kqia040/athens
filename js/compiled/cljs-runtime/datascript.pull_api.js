...
var depth = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39429__$1,new cljs.core.Keyword(null,"depth","depth",1768663640));
var seen = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39429__$1,new cljs.core.Keyword(null,"seen","seen",-518999789));
...
var G__39444 = new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame);
var G__39444__$1 = (((G__39444 == null))?null:cljs.core.persistent_BANG_(G__39444));
if((G__39444__$1 == null)){
return null;
} else {
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__39444__$1,key);
}
});
...
datascript.pull_api.pull_recursion_frame = (function datascript$pull_api$pull_recursion_frame(db,p__39456){
...
var frame = first__39459;
var frames = seq__39458__$1;
...
var results = (function (){var G__39464 = new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(frame);
if(cljs.core.seq(kvps)){
return cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(G__39464,kvps);
} else {
return G__39464;
}
})();
...
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39471__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39471__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
var pattern_39631 = (new datascript.pull_parser.PullSpec(true,cljs.core.PersistentArrayMap.EMPTY,null,null,null));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(datascript.pull_api.subpattern_frame(pattern_39631,eids,multi_QMARK_,attr_key),new cljs.core.Keyword(null,"recursion","recursion",-749738765),rec);
});
datascript.pull_api.pull_attr_datoms = (function datascript$pull_api$pull_attr_datoms(db,attr_key,attr,eid,forward_QMARK_,datoms,opts,p__39485){
var vec__39486 = p__39485;
var seq__39487 = cljs.core.seq(vec__39486);
var first__39488 = cljs.core.first(seq__39487);
var seq__39487__$1 = cljs.core.next(seq__39487);
var parent = first__39488;
var frames = seq__39487__$1;
...
var found = cljs.core.not_empty((function (){var G__39490 = datoms;
if(cljs.core.truth_(limit)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.take.cljs$core$IFn$_invoke$arity$1(limit),G__39490);
} else {
return G__39490;
}
})());
...
var as_value = (function (){var G__39495 = datom_val;
if(ref_QMARK_){
return cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__39482_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword("db","id","db/id",-1388397098)],[p1__39482_SHARP_]);
}),G__39495);
} else {
return G__39495;
}
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,cljs.core.update.cljs$core$IFn$_invoke$arity$5(parent,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,(function (){var G__39496 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1(as_value),found);
if(single_QMARK_){
return cljs.core.first(G__39496);
} else {
return G__39496;
}
})()));
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,(function (){var G__39497 = parent;
if(cljs.core.contains_QMARK_(opts,new cljs.core.Keyword(null,"default","default",-1987822328))){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__39497,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,new cljs.core.Keyword(null,"default","default",-1987822328).cljs$core$IFn$_invoke$arity$1(opts));
} else {
return G__39497;
}
})());
...
var vec__39498 = spec;
var attr_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39498,(0),null);
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39498,(1),null);
...
datascript.pull_api.filter_reverse_attrs = cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p__39505){
var vec__39506 = p__39505;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39506,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39506,(1),null);
...
datascript.pull_api.pull_expand_reverse_frame = (function datascript$pull_api$pull_expand_reverse_frame(db,p__39509){
...
var frame = first__39512;
var frames = seq__39511__$1;
...
datascript.pull_api.pull_expand_frame = (function datascript$pull_api$pull_expand_frame(db,p__39514){
...
var frame = first__39517;
var frames = seq__39516__$1;
...
var vec__39525 = cljs.core.first(datoms_by_attr);
var attr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39525,(0),null);
var datoms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39525,(1),null);
...
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39536__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39536__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var rec = (function (){var G__39542 = recursion;
if((!((attr == null)))){
return datascript.pull_api.push_recursion(G__39542,attr,eid);
} else {
return G__39542;
}
})();
...
var eid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39544__$1,new cljs.core.Keyword(null,"eid","eid",559519930));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39544__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
datascript.pull_api.pull_pattern_frame = (function datascript$pull_api$pull_pattern_frame(db,p__39550){
while(true){
var vec__39553 = p__39550;
var seq__39554 = cljs.core.seq(vec__39553);
var first__39555 = cljs.core.first(seq__39554);
var seq__39554__$1 = cljs.core.next(seq__39554);
var frame = first__39555;
var frames = seq__39554__$1;
var temp__5733__auto__ = cljs.core.seq(new cljs.core.Keyword(null,"eids","eids",1546550700).cljs$core$IFn$_invoke$arity$1(frame));
if(temp__5733__auto__){
var eids = temp__5733__auto__;
...
var G__39706 = db;
var G__39707 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,datascript.pull_api.reset_frame(frame,cljs.core.rest(eids),cljs.core.not_empty(cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__39706;
p__39550 = G__39707;
continue;
}
...
while(true){
var G__39563 = new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first(frames));
var G__39563__$1 = (((G__39563 instanceof cljs.core.Keyword))?G__39563.fqn:null);
switch (G__39563__$1) {
case "expand":
var G__39713 = db;
var G__39714 = datascript.pull_api.pull_expand_frame(db,frames);
db = G__39713;
frames = G__39714;
continue;
...
case "expand-rev":
var G__39718 = db;
var G__39719 = datascript.pull_api.pull_expand_reverse_frame(db,frames);
db = G__39718;
frames = G__39719;
continue;
...
case "pattern":
var G__39722 = db;
var G__39723 = datascript.pull_api.pull_pattern_frame(db,frames);
db = G__39722;
frames = G__39723;
continue;
...
case "recursion":
var G__39725 = db;
var G__39726 = datascript.pull_api.pull_recursion_frame(db,frames);
db = G__39725;
frames = G__39726;
continue;
...
var f = first__39570;
var remaining = seq__39569__$1;
var result = (function (){var G__39571 = cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(f));
if(cljs.core.not(new cljs.core.Keyword(null,"multi?","multi?",-749311069).cljs$core$IFn$_invoke$arity$1(f))){
return cljs.core.first(G__39571);
} else {
return G__39571;
}
})();
...
var G__39730 = db;
var G__39731 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.rest(remaining),(function (){var G__39574 = cljs.core.first(remaining);
if(cljs.core.truth_(result)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__39574,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(f),result);
} else {
return G__39574;
}
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__39563__$1)].join('')));
...
var eids__$1 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__39578_SHARP_){
return datascript.db.entid_strict(db,p1__39578_SHARP_);
})),eids);
