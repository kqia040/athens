...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__56983_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__56983_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__56982_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__56982_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__56986_SHARP_){
return (((p1__56986_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__56986_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__57003,mapping){
var map__57004 = p__57003;
var map__57004__$1 = (((((!((map__57004 == null))))?(((((map__57004.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__57004.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__57004):map__57004);
var state = map__57004__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57004__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57004__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57004__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__56997_SHARP_){
if((p1__56997_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__56997_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__57243 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__57245 = clojure.zip.next(loc);
loc = G__57245;
continue;
}
}
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__57079){
var vec__57081 = p__57079;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57081,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq57071){
var G__57072 = cljs.core.first(seq57071);
var seq57071__$1 = cljs.core.next(seq57071);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57072,seq57071__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__57088_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__57088_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__57097_57282 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__57098_57283 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__57099_57284 = true;
var _STAR_print_fn_STAR__temp_val__57100_57285 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__57099_57284);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__57100_57285);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__57098_57283);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__57097_57282);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4667__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__57093_SHARP_){
return debux.common.util.prepend_bars(p1__57093_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__57288 = cljs.core.next(opts__$1);
var G__57289 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__57288;
acc = G__57289;
continue;
} else {
if(typeof f === 'string'){
var G__57290 = cljs.core.next(opts__$1);
var G__57291 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__57290;
acc = G__57291;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__57292 = cljs.core.nnext(opts__$1);
var G__57293 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__57292;
acc = G__57293;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__57301 = cljs.core.next(opts__$1);
var G__57302 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__57301;
acc = G__57302;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__57125 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__57125.cljs$core$IFn$_invoke$arity$1 ? fexpr__57125.cljs$core$IFn$_invoke$arity$1(f) : fexpr__57125.call(null,f));
})())){
var G__57306 = cljs.core.next(opts__$1);
var G__57307 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__57306;
acc = G__57307;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__57126 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__57126.cljs$core$IFn$_invoke$arity$1 ? fexpr__57126.cljs$core$IFn$_invoke$arity$1(f) : fexpr__57126.call(null,f));
})())){
var G__57308 = cljs.core.nnext(opts__$1);
var G__57309 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__57308;
acc = G__57309;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__57310 = cljs.core.next(opts__$1);
var G__57311 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__57310;
acc = G__57311;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__57133){
var vec__57134 = p__57133;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57134,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57134,(1),null);
...
var G__57146 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__57145 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten)(form);
return (fexpr__57145.cljs$core$IFn$_invoke$arity$1 ? fexpr__57145.cljs$core$IFn$_invoke$arity$1(G__57146) : fexpr__57145.call(null,G__57146));
});
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__57160 = quoted_form;
var G__57161 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__57160,G__57161) : debux.common.util.remove_d.call(null,G__57160,G__57161));
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__57166 = quoted_form;
var G__57167 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__57166,G__57167) : debux.common.util.remove_d.call(null,G__57166,G__57167));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__57326__delegate = function (arg){
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__57183 = quoted_form;
var G__57184 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__57183,G__57184) : debux.common.util.remove_d.call(null,G__57183,G__57184));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
var G__57328__i = 0, G__57328__a = new Array(arguments.length -  0);
while (G__57328__i < G__57328__a.length) {G__57328__a[G__57328__i] = arguments[G__57328__i + 0]; ++G__57328__i;}
  arg = new cljs.core.IndexedSeq(G__57328__a,0,null);
} 
return G__57326__delegate.call(this,arg);};
G__57326.cljs$lang$maxFixedArity = 0;
G__57326.cljs$lang$applyTo = (function (arglist__57329){
var arg = cljs.core.seq(arglist__57329);
return G__57326__delegate(arg);
});
...
var G__57338 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__57338;
continue;
} else {
...
var G__57342 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__57342;
continue;
} else {
var G__57344 = clojure.zip.next(loc);
loc = G__57344;
continue;
