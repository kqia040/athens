...
if((x instanceof cljs.core.Keyword)){
var G__51894 = spec;
var G__51895 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__51894,G__51895) : f.call(null,G__51894,G__51895));
} else {
if(typeof x === 'string'){
...
if((x instanceof cljs.core.Keyword)){
var G__51907 = spec;
var G__51908 = spec_tools.transform.keyword__GT_string(spec,x);
...
}catch (e51913){if((e51913 instanceof Error)){
var ___$1 = e51913;
return x;
} else {
throw e51913;
...
}catch (e51917){if((e51917 instanceof Error)){
var ___$1 = e51917;
return x;
} else {
throw e51917;
...
}catch (e51923){if((e51923 instanceof Error)){
var ___$1 = e51923;
return x;
} else {
throw e51923;
...
spec_tools.transform.strip_extra_keys = (function spec_tools$transform$strip_extra_keys(p__51955,x){
var map__51956 = p__51955;
var map__51956__$1 = (((((!((map__51956 == null))))?(((((map__51956.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__51956.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__51956):map__51956);
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51956__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.fail_on_extra_keys = (function spec_tools$transform$fail_on_extra_keys(p__51958,x){
...
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51959__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.strip_extra_values = (function spec_tools$transform$strip_extra_values(p__51961,x){
...
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51962__$1,new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600));
