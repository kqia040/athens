...
var seq__56197 = cljs.core.seq(imgs);
var chunk__56198 = null;
var count__56199 = (0);
var i__56200 = (0);
while(true){
if((i__56200 < count__56199)){
var vec__56207 = chunk__56198.cljs$core$IIndexed$_nth$arity$2(null,i__56200);
var curr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56207,(0),null);
var new$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56207,(1),null);
athens.electron.fs.copyFileSync(curr,new$);


var G__56380 = seq__56197;
var G__56381 = chunk__56198;
var G__56382 = count__56199;
var G__56383 = (i__56200 + (1));
seq__56197 = G__56380;
chunk__56198 = G__56381;
count__56199 = G__56382;
i__56200 = G__56383;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__56197);
if(temp__5735__auto__){
var seq__56197__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__56197__$1)){
var c__4556__auto__ = cljs.core.chunk_first(seq__56197__$1);
var G__56386 = cljs.core.chunk_rest(seq__56197__$1);
var G__56387 = c__4556__auto__;
var G__56388 = cljs.core.count(c__4556__auto__);
var G__56389 = (0);
seq__56197 = G__56386;
chunk__56198 = G__56387;
count__56199 = G__56388;
i__56200 = G__56389;
continue;
} else {
var vec__56213 = cljs.core.first(seq__56197__$1);
var curr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56213,(0),null);
var new$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56213,(1),null);
athens.electron.fs.copyFileSync(curr,new$);


var G__56392 = cljs.core.next(seq__56197__$1);
var G__56393 = null;
var G__56394 = (0);
var G__56395 = (0);
seq__56197 = G__56392;
chunk__56198 = G__56393;
count__56199 = G__56394;
i__56200 = G__56395;
continue;
}
} else {
...
var map__56253 = athens.db.get_block(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uid","block/uid",-1623585167),target_uid], null));
...
var order = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56253__$1,new cljs.core.Keyword("block","order","block/order",-1429282437));
...
})():(function (){var index = (function (){var G__56276 = drag_target;
var G__56276__$1 = (((G__56276 instanceof cljs.core.Keyword))?G__56276.fqn:null);
switch (G__56276__$1) {
case "above":
return (order - (1));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__56276__$1)].join('')));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("fs","open-dialog","fs/open-dialog",-1381619732),(function (p__56287,_){
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56288__$1,new cljs.core.Keyword(null,"db","db",993250759));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("local-storage","get-db-filepath","local-storage/get-db-filepath",-2015649354),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_frame.core.inject_cofx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"local-storage","local-storage",-1301104068),"db/filepath")], null),(function (p__56294,_){
...
var local_storage = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56295__$1,new cljs.core.Keyword(null,"local-storage","local-storage",-1301104068));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("local-storage","navigate","local-storage/navigate",-707087458),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_frame.core.inject_cofx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"local-storage","local-storage",-1301104068),"current-route/uid")], null),(function (p__56308,_){
...
var local_storage = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56309__$1,new cljs.core.Keyword(null,"local-storage","local-storage",-1301104068));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("fs","watch","fs/watch",380976938),(function (_,p__56323){
var vec__56324 = p__56323;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56324,(0),null);
var filepath = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56324,(1),null);
var dirpath_56500 = athens.electron.path.dirname(filepath);
athens.electron.fs.watch(dirpath_56500,(function (_event,filename){
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("db","update-mtime","db/update-mtime",768440096),(function (db,p__56328){
var vec__56329 = p__56328;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56329,(0),null);
var mtime1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56329,(1),null);
var map__56332 = db;
...
var filepath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56332__$1,new cljs.core.Keyword("db","filepath","db/filepath",1097485287));
...
re_frame.core.reg_fx(new cljs.core.Keyword("fs","write!","fs/write!",-1029545496),(function (p__56367){
var vec__56369 = p__56367;
var filepath = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56369,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56369,(1),null);
