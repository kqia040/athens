...
var sablono$interpreter$IInterpreter$interpret$dyn_42801 = (function (this$){
...
return sablono$interpreter$IInterpreter$interpret$dyn_42801(this$);
}
});
...
var x42727_42804 = ctor.prototype;
(x42727_42804.onChange = (function (event){
var this$ = this;
...
(x42727_42804.componentWillReceiveProps = (function (new_props){
var this$ = this;
...
switch (G__42763) {
case "input":
var G__42764 = ((cljs.core.object_QMARK_(props))?props.type:false);
switch (G__42764) {
case "radio":
...
var len__4736__auto___42834 = arguments.length;
var i__4737__auto___42835 = (0);
while(true){
if((i__4737__auto___42835 < len__4736__auto___42834)){
args__4742__auto__.push((arguments[i__4737__auto___42835]));

var G__42836 = (i__4737__auto___42835 + (1));
i__4737__auto___42835 = G__42836;
continue;
} else {
}
break;
...
/** @this {Function} */
(sablono.interpreter.create_element.cljs$lang$applyTo = (function (seq42770){
var G__42771 = cljs.core.first(seq42770);
var seq42770__$1 = cljs.core.next(seq42770);
var G__42772 = cljs.core.first(seq42770__$1);
var seq42770__$2 = cljs.core.next(seq42770__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42771,G__42772,seq42770__$2);
}));
...
var vec__42786 = sablono.normalize.element(element);
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42786,(0),null);
var attrs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42786,(1),null);
var content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42786,(2),null);
