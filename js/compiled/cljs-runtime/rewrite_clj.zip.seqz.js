...
var G__29407 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(n0) : f.call(null,n0));
var G__29407__$1 = (((G__29407 == null))?null:cljs.core.iterate((function (loc){
...
var G__29407__$2 = (((G__29407__$1 == null))?null:cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__29407__$1));
var G__29407__$3 = (((G__29407__$2 == null))?null:cljs.core.last(G__29407__$2));
if((G__29407__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up(G__29407__$3);
}
} else {
return zloc;
}
...
var G__29472 = rewrite_clj.zip.move.right(v);
var G__29473 = rewrite_clj.zip.move.up(v);
loc = G__29472;
parent = G__29473;
continue;
} else {
var G__29474 = rewrite_clj.zip.move.right(v0);
var G__29475 = parent;
loc = G__29474;
parent = G__29475;
continue;
...
var G__29478 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(v));
var G__29479 = rewrite_clj.zip.move.up(v);
loc = G__29478;
parent = G__29479;
continue;
} else {
var G__29483 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__29484 = parent;
loc = G__29483;
parent = G__29484;
continue;
...
if(rewrite_clj.zip.seqz.map_QMARK_(zloc)){
var G__29446 = zloc;
var G__29446__$1 = (((G__29446 == null))?null:rewrite_clj.zip.move.down(G__29446));
var G__29446__$2 = (((G__29446__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__29446__$1,k));
if((G__29446__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__29446__$2);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__29449 = rewrite_clj.zip.move.down(zloc);
var G__29449__$1 = (((G__29449 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__29449));
if((G__29449__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__29449__$1);
}
})(),k);
}
});
