...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__50758_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__50758_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__50757_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__50757_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__50760_SHARP_){
return (((p1__50760_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__50760_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__50776,mapping){
...
var state = map__50777__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50777__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50777__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50777__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__50772_SHARP_){
if((p1__50772_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__50772_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__51018 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__51022 = clojure.zip.next(loc);
loc = G__51022;
continue;
}
}
...
var len__4736__auto___51047 = arguments.length;
var i__4737__auto___51049 = (0);
while(true){
if((i__4737__auto___51049 < len__4736__auto___51047)){
args__4742__auto__.push((arguments[i__4737__auto___51049]));

var G__51050 = (i__4737__auto___51049 + (1));
i__4737__auto___51049 = G__51050;
continue;
} else {
}
break;
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__50852){
var vec__50853 = p__50852;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50853,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq50844){
var G__50845 = cljs.core.first(seq50844);
var seq50844__$1 = cljs.core.next(seq50844);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__50845,seq50844__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__50862_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__50862_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__50870_51055 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__50871_51056 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__50872_51057 = true;
var _STAR_print_fn_STAR__temp_val__50873_51058 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__50872_51057);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__50873_51058);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__50871_51056);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__50870_51055);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4667__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__50865_SHARP_){
return debux.common.util.prepend_bars(p1__50865_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__51069 = cljs.core.next(opts__$1);
var G__51070 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__51069;
acc = G__51070;
continue;
} else {
if(typeof f === 'string'){
var G__51071 = cljs.core.next(opts__$1);
var G__51072 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__51071;
acc = G__51072;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__51073 = cljs.core.nnext(opts__$1);
var G__51074 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__51073;
acc = G__51074;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__51075 = cljs.core.next(opts__$1);
var G__51076 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__51075;
acc = G__51076;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__50897 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__50897.cljs$core$IFn$_invoke$arity$1 ? fexpr__50897.cljs$core$IFn$_invoke$arity$1(f) : fexpr__50897.call(null,f));
})())){
var G__51079 = cljs.core.next(opts__$1);
var G__51080 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__51079;
acc = G__51080;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__50899 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__50899.cljs$core$IFn$_invoke$arity$1 ? fexpr__50899.cljs$core$IFn$_invoke$arity$1(f) : fexpr__50899.call(null,f));
})())){
var G__51083 = cljs.core.nnext(opts__$1);
var G__51084 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__51083;
acc = G__51084;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__51085 = cljs.core.next(opts__$1);
var G__51086 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__51085;
acc = G__51086;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__50904){
...
var G__50921 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__50920 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten)(form);
return (fexpr__50920.cljs$core$IFn$_invoke$arity$1 ? fexpr__50920.cljs$core$IFn$_invoke$arity$1(G__50921) : fexpr__50920.call(null,G__50921));
});
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__50931 = quoted_form;
var G__50932 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__50931,G__50932) : debux.common.util.remove_d.call(null,G__50931,G__50932));
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__50938 = quoted_form;
var G__50939 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__50938,G__50939) : debux.common.util.remove_d.call(null,G__50938,G__50939));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__51105__delegate = function (arg){
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__50949 = quoted_form;
var G__50950 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__50949,G__50950) : debux.common.util.remove_d.call(null,G__50949,G__50950));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));

return result;
};
var G__51105 = function (var_args){
var arg = null;
if (arguments.length > 0) {
var G__51115__i = 0, G__51115__a = new Array(arguments.length -  0);
while (G__51115__i < G__51115__a.length) {G__51115__a[G__51115__i] = arguments[G__51115__i + 0]; ++G__51115__i;}
  arg = new cljs.core.IndexedSeq(G__51115__a,0,null);
} 
return G__51105__delegate.call(this,arg);};
G__51105.cljs$lang$maxFixedArity = 0;
G__51105.cljs$lang$applyTo = (function (arglist__51119){
var arg = cljs.core.seq(arglist__51119);
return G__51105__delegate(arg);
});
G__51105.cljs$core$IFn$_invoke$arity$variadic = G__51105__delegate;
return G__51105;
})()
;
});
...
var G__51124 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__51124;
continue;
} else {
...
var G__51129 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__51129;
continue;
} else {
var G__51131 = clojure.zip.next(loc);
loc = G__51131;
continue;
