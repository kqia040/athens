...
var len__4736__auto___21257 = arguments.length;
var i__4737__auto___21258 = (0);
while(true){
if((i__4737__auto___21258 < len__4736__auto___21257)){
args__4742__auto__.push((arguments[i__4737__auto___21258]));

var G__21259 = (i__4737__auto___21258 + (1));
i__4737__auto___21258 = G__21259;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq21205){
var G__21206 = cljs.core.first(seq21205);
var seq21205__$1 = cljs.core.next(seq21205);
var G__21207 = cljs.core.first(seq21205__$1);
var seq21205__$2 = cljs.core.next(seq21205__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21206,G__21207,seq21205__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__21217_SHARP_){
return (!((cljs.core.meta(p1__21217_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21231__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e21236){var _e__20352__auto__ = e21236;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e21242){var _e__20352__auto__ = e21242;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__21244 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__21245 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__21245);

try{var map__21246 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21246__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__21244);
}});
...
var temp__5733__auto___21267 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___21267)){
var managed_print_level_21268 = temp__5733__auto___21267;
var _STAR_print_level_STAR__orig_val__21251_21269 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__21252_21270 = managed_print_level_21268;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__21252_21270);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__21249_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__21249_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__21251_21269);
}} else {
job_fn();
}
