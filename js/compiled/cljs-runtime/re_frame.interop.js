...
return [(function (){var pred__30966 = cljs.core.instance_QMARK_;
var expr__30967 = reactive_val;
if(cljs.core.truth_((pred__30966.cljs$core$IFn$_invoke$arity$2 ? pred__30966.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__30967) : pred__30966.call(null,reagent.ratom.RAtom,expr__30967)))){
return "ra";
} else {
if(cljs.core.truth_((pred__30966.cljs$core$IFn$_invoke$arity$2 ? pred__30966.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__30967) : pred__30966.call(null,reagent.ratom.RCursor,expr__30967)))){
return "rc";
} else {
if(cljs.core.truth_((pred__30966.cljs$core$IFn$_invoke$arity$2 ? pred__30966.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__30967) : pred__30966.call(null,reagent.ratom.Reaction,expr__30967)))){
return "rx";
} else {
if(cljs.core.truth_((pred__30966.cljs$core$IFn$_invoke$arity$2 ? pred__30966.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__30967) : pred__30966.call(null,reagent.ratom.Track,expr__30967)))){
return "tr";
} else {
return "other";
}
