...
if((c === "\n")){
var G__28990 = escape_QMARK_;
var G__28991 = rewrite_clj.parser.string.flush_into(lines,buf);
escape_QMARK_ = G__28990;
lines = G__28991;
continue;
} else {
buf.append(c);

var G__28992 = ((cljs.core.not(escape_QMARK_)) && ((c === "\\")));
var G__28993 = lines;
escape_QMARK_ = G__28992;
lines = G__28993;
continue;
...
var G__28979 = rewrite_clj.parser.string.read_string_data(reader);
return (rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1(G__28979) : rewrite_clj.node.string_node.call(null,G__28979));
});
...
var G__28983 = cljs.core.re_pattern(regex);
var G__28984 = ["#\"",regex,"\""].join('');
return (rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2(G__28983,G__28984) : rewrite_clj.node.token_node.call(null,G__28983,G__28984));
});
