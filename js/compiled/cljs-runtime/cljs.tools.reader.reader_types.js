...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_23553 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_23553(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_23555 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_23555(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_23561 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_23561(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_23562 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_23562(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_23576 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_23576(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_23582 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_23582(reader);
}
});
...
var G__23647 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__23648 = s.append(c);
c = G__23647;
s = G__23648;
continue;
}
