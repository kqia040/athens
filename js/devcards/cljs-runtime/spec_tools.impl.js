...
var vec__51188 = cljs.core.rest(expr);
var seq__51189 = cljs.core.seq(vec__51188);
var first__51190 = cljs.core.first(seq__51189);
var seq__51189__$1 = cljs.core.next(seq__51189);
var vec__51191 = first__51190;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51191,(0),null);
var form = seq__51189__$1;
...
var G__51197 = x;
var G__51197__$1 = (((G__51197 == null))?null:spec_tools.impl.polish(G__51197));
var G__51197__$2 = (((G__51197__$1 == null))?null:cljs.core.name(G__51197__$1));
if((G__51197__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__51197__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__51198 = x;
var G__51198__$1 = (((G__51198 == null))?null:cljs.core.name(G__51198));
if((G__51198__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__51198__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__51199){
...
var data = map__51200__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51200__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51200__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51200__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51200__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__51209){
...
var data = map__51210__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51210__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51210__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__51212 = data;
var G__51212__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__51212,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__51212);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__51212__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__51212__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__51216 = form;
var G__51216__$1 = (((G__51216 == null))?null:cljs.core.rest(G__51216));
if((G__51216__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__51216__$1);
}
})();
var G__51219 = m;
var G__51219__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__51219,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__51213_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__51213_SHARP_)));
})):G__51219);
var G__51219__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__51219__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__51214_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__51214_SHARP_)));
})):G__51219__$1);
var G__51219__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__51219__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__51215_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__51215_SHARP_));
})):G__51219__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__51219__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__51234 = (function (){var G__51235 = form;
var G__51235__$1 = (((G__51235 == null))?null:cljs.core.rest(G__51235));
if((G__51235__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__51235__$1);
}
})();
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51234__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51234__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51234__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51234__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__51249 = (((kw instanceof cljs.core.Symbol))?cljs.core.namespace(kw):false);
switch (G__51249) {
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__51254 = form;
var G__51254__$1 = (((G__51254 == null))?null:cljs.core.seq(G__51254));
var G__51254__$2 = (((G__51254__$1 == null))?null:cljs.core.first(G__51254__$1));
if((G__51254__$2 == null)){
return null;
} else {
var fexpr__51255 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__51255.cljs$core$IFn$_invoke$arity$1 ? fexpr__51255.cljs$core$IFn$_invoke$arity$1(G__51254__$2) : fexpr__51255.call(null,G__51254__$2));
}
})():null));
});
/**
...
var len__4736__auto___51359 = arguments.length;
var i__4737__auto___51360 = (0);
while(true){
if((i__4737__auto___51360 < len__4736__auto___51359)){
args__4742__auto__.push((arguments[i__4737__auto___51360]));

var G__51361 = (i__4737__auto___51360 + (1));
i__4737__auto___51360 = G__51361;
continue;
} else {
}
break;
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq51261){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq51261));
}));
...
var vec__51267 = p__51265;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51267,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51267,(1),null);
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__51284){
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51285__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51285__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51285__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51285__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__51280_SHARP_){
return cljs.core.map_QMARK_(p1__51280_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__51281_SHARP_){
return cljs.core.contains_QMARK_(p1__51281_SHARP_,x);
});
}),req_keys));
