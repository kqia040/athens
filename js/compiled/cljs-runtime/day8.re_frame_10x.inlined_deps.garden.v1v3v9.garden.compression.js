 ...
 */
day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.compression.token_fn = (function day8$re_frame_10x$inlined_deps$garden$v1v3v9$garden$compression$token_fn(p__25248){
var vec__25251 = p__25248;
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25251,(0),null);
var re = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25251,(1),null);
return (function (s){
...
var i__4737__auto___25312 = (0);
while(true){
if((i__4737__auto___25312 < len__4736__auto___25310)){
args__4742__auto__.push((arguments[i__4737__auto___25312]));

var G__25313 = (i__4737__auto___25312 + (1));
i__4737__auto___25312 = G__25313;
continue;
} else {
}
break;
...
return (function (s){
return cljs.core.some((function (p1__25258_SHARP_){
return (p1__25258_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p1__25258_SHARP_.cljs$core$IFn$_invoke$arity$1(s) : p1__25258_SHARP_.call(null,s));
}),fs);
});
}));
...
/** @this {Function} */
(day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.compression.tokenizer.cljs$lang$applyTo = (function (seq25261){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq25261));
}));
...
var map__25297 = temp__5733__auto__;
var map__25297__$1 = (((((!((map__25297 == null))))?(((((map__25297.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__25297.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__25297):map__25297);
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25297__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var chunk = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25297__$1,new cljs.core.Keyword(null,"chunk","chunk",-1191159620));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25297__$1,new cljs.core.Keyword(null,"size","size",1098693007));
var G__25329 = cljs.core.subs.cljs$core$IFn$_invoke$arity$2(s1,size);
var G__25330 = [s2,cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__25303 = tag;
var G__25303__$1 = (((G__25303 instanceof cljs.core.Keyword))?G__25303.fqn:null);
switch (G__25303__$1) {
case "string":
return chunk;
