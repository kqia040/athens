...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k28354,else__4383__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k28354,else__4383__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__28370){
var vec__28371 = p__28370;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28371,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28371,(1),null);
...
return cljs.core.pr_sequential_writer(writer__4395__auto__,pr_pair__4397__auto__,"#rewrite-clj.node.quote.QuoteNode{",", ","}",opts__4396__auto__,cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [(new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.Keyword(null,"tag","tag",-1290361223),self__.tag],null)),(new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.Keyword(null,"prefix","prefix",-265908465),self__.prefix],null)),(new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.Keyword(null,"sym","sym",-1444860305),self__.sym],null)),(new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.Keyword(null,"children","children",-940561982),self__.children],null))], null),self__.__extmap));
}));

(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__28353){
var self__ = this;
var G__28353__$1 = this;
return (new cljs.core.RecordIter((0),G__28353__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"sym","sym",-1444860305),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this28355,other28356){
var self__ = this;
var this28355__$1 = this;
return (((!((other28356 == null)))) && ((this28355__$1.constructor === other28356.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this28355__$1.tag,other28356.tag)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this28355__$1.prefix,other28356.prefix)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this28355__$1.sym,other28356.sym)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this28355__$1.children,other28356.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this28355__$1.__extmap,other28356.__extmap)));
}));
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__28353){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__28400 = cljs.core.keyword_identical_QMARK_;
var expr__28401 = k__4388__auto__;
if(cljs.core.truth_((pred__28400.cljs$core$IFn$_invoke$arity$2 ? pred__28400.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__28401) : pred__28400.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__28401)))){
return (new rewrite_clj.node.quote.QuoteNode(G__28353,self__.prefix,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__28400.cljs$core$IFn$_invoke$arity$2 ? pred__28400.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__28401) : pred__28400.call(null,new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__28401)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,G__28353,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__28400.cljs$core$IFn$_invoke$arity$2 ? pred__28400.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"sym","sym",-1444860305),expr__28401) : pred__28400.call(null,new cljs.core.Keyword(null,"sym","sym",-1444860305),expr__28401)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,G__28353,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__28400.cljs$core$IFn$_invoke$arity$2 ? pred__28400.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__28401) : pred__28400.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__28401)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,G__28353,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__28353),null));
}
}
}
}
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__28353){
var self__ = this;
var this__4379__auto____$1 = this;
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,G__28353,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.quote.map__GT_QuoteNode = (function rewrite_clj$node$quote$map__GT_QuoteNode(G__28357){
var extmap__4419__auto__ = (function (){var G__28410 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__28357,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"sym","sym",-1444860305),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
...
return (new rewrite_clj.node.quote.QuoteNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__28357),new cljs.core.Keyword(null,"prefix","prefix",-265908465).cljs$core$IFn$_invoke$arity$1(G__28357),new cljs.core.Keyword(null,"sym","sym",-1444860305).cljs$core$IFn$_invoke$arity$1(G__28357),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__28357),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
...
var G__28446 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__28446;
continue;
}
break;
...
var G__28447 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__28447;
continue;
}
break;
...
var G__28448 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__28448;
continue;
}
break;
...
var G__28449 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__28449;
continue;
}
break;
