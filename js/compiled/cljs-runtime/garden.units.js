 ...
 */
garden.units.convert = (function garden$units$convert(p__40776,right){
var map__40777 = p__40776;
var map__40777__$1 = (((((!((map__40777 == null))))?(((((map__40777.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__40777.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__40777):map__40777);
var m = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40777__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var left = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40777__$1,new cljs.core.Keyword(null,"unit","unit",375175175));
...
var vec__40793 = temp__5735__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40793,(0),null);
var magnitude = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40793,(1),null);
var unit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40793,(2),null);
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40828__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__40829 = u(y);
var map__40829__$1 = (((((!((map__40829 == null))))?(((((map__40829.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__40829.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__40829):map__40829);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40829__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 + m2));
});
var garden$units$make_unit_adder_$_u_PLUS___3 = (function() { 
var G__41031__delegate = function (x,y,more){
...
var G__41031 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__41033__i = 0, G__41033__a = new Array(arguments.length -  2);
while (G__41033__i < G__41033__a.length) {G__41033__a[G__41033__i] = arguments[G__41033__i + 2]; ++G__41033__i;}
  more = new cljs.core.IndexedSeq(G__41033__a,0,null);
} 
return G__41031__delegate.call(this,x,y,more);};
G__41031.cljs$lang$maxFixedArity = 2;
G__41031.cljs$lang$applyTo = (function (arglist__41034){
var x = cljs.core.first(arglist__41034);
arglist__41034 = cljs.core.next(arglist__41034);
var y = cljs.core.first(arglist__41034);
var more = cljs.core.rest(arglist__41034);
return G__41031__delegate(x,y,more);
});
...
var G__41036 = null;
if (arguments.length > 2) {
var G__41037__i = 0, G__41037__a = new Array(arguments.length -  2);
while (G__41037__i < G__41037__a.length) {G__41037__a[G__41037__i] = arguments[G__41037__i + 2]; ++G__41037__i;}
G__41036 = new cljs.core.IndexedSeq(G__41037__a,0,null);
}
return garden$units$make_unit_adder_$_u_PLUS___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__41036);
}
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40844__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__40845 = u(y);
...
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40845__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 - m2));
});
var garden$units$make_unit_subtractor_$_u___3 = (function() { 
var G__41046__delegate = function (x,y,more){
...
var G__41046 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__41047__i = 0, G__41047__a = new Array(arguments.length -  2);
while (G__41047__i < G__41047__a.length) {G__41047__a[G__41047__i] = arguments[G__41047__i + 2]; ++G__41047__i;}
  more = new cljs.core.IndexedSeq(G__41047__a,0,null);
} 
return G__41046__delegate.call(this,x,y,more);};
G__41046.cljs$lang$maxFixedArity = 2;
G__41046.cljs$lang$applyTo = (function (arglist__41048){
var x = cljs.core.first(arglist__41048);
arglist__41048 = cljs.core.next(arglist__41048);
var y = cljs.core.first(arglist__41048);
var more = cljs.core.rest(arglist__41048);
return G__41046__delegate(x,y,more);
});
...
var G__41050 = null;
if (arguments.length > 2) {
var G__41051__i = 0, G__41051__a = new Array(arguments.length -  2);
while (G__41051__i < G__41051__a.length) {G__41051__a[G__41051__i] = arguments[G__41051__i + 2]; ++G__41051__i;}
G__41050 = new cljs.core.IndexedSeq(G__41051__a,0,null);
}
return garden$units$make_unit_subtractor_$_u___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__41050);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var map__40871 = u(x);
var map__40871__$1 = (((((!((map__40871 == null))))?(((((map__40871.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__40871.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__40871):map__40871);
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40871__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__40872 = u(y);
...
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40872__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
...
var G__41055__delegate = function (x,y,more){
...
var G__41055 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__41057__i = 0, G__41057__a = new Array(arguments.length -  2);
while (G__41057__i < G__41057__a.length) {G__41057__a[G__41057__i] = arguments[G__41057__i + 2]; ++G__41057__i;}
  more = new cljs.core.IndexedSeq(G__41057__a,0,null);
} 
return G__41055__delegate.call(this,x,y,more);};
G__41055.cljs$lang$maxFixedArity = 2;
G__41055.cljs$lang$applyTo = (function (arglist__41060){
var x = cljs.core.first(arglist__41060);
arglist__41060 = cljs.core.next(arglist__41060);
var y = cljs.core.first(arglist__41060);
var more = cljs.core.rest(arglist__41060);
return G__41055__delegate(x,y,more);
});
...
var G__41064 = null;
if (arguments.length > 2) {
var G__41065__i = 0, G__41065__a = new Array(arguments.length -  2);
while (G__41065__i < G__41065__a.length) {G__41065__a[G__41065__i] = arguments[G__41065__i + 2]; ++G__41065__i;}
G__41064 = new cljs.core.IndexedSeq(G__41065__a,0,null);
}
return garden$units$make_unit_multiplier_$_u_STAR___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__41064);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40896__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__40897 = u(y);
...
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40897__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((op.cljs$core$IFn$_invoke$arity$2 ? op.cljs$core$IFn$_invoke$arity$2(m1,m2) : op.call(null,m1,m2)));
});
var garden$units$make_unit_divider_$_ud__3 = (function() { 
var G__41087__delegate = function (x,y,more){
...
var G__41087 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__41089__i = 0, G__41089__a = new Array(arguments.length -  2);
while (G__41089__i < G__41089__a.length) {G__41089__a[G__41089__i] = arguments[G__41089__i + 2]; ++G__41089__i;}
  more = new cljs.core.IndexedSeq(G__41089__a,0,null);
} 
return G__41087__delegate.call(this,x,y,more);};
G__41087.cljs$lang$maxFixedArity = 2;
G__41087.cljs$lang$applyTo = (function (arglist__41093){
var x = cljs.core.first(arglist__41093);
arglist__41093 = cljs.core.next(arglist__41093);
var y = cljs.core.first(arglist__41093);
var more = cljs.core.rest(arglist__41093);
return G__41087__delegate(x,y,more);
});
...
var G__41099 = null;
if (arguments.length > 2) {
var G__41100__i = 0, G__41100__a = new Array(arguments.length -  2);
while (G__41100__i < G__41100__a.length) {G__41100__a[G__41100__i] = arguments[G__41100__i + 2]; ++G__41100__i;}
G__41099 = new cljs.core.IndexedSeq(G__41100__a,0,null);
}
return garden$units$make_unit_divider_$_ud__3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__41099);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
