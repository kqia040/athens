...
if((x instanceof cljs.core.Keyword)){
var G__58186 = spec;
var G__58187 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__58186,G__58187) : f.call(null,G__58186,G__58187));
} else {
if(typeof x === 'string'){
...
if((x instanceof cljs.core.Keyword)){
var G__58191 = spec;
var G__58192 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__58191,G__58192) : f.call(null,G__58191,G__58192));
} else {
return x;
...
}catch (e58195){if((e58195 instanceof Error)){
var ___$1 = e58195;
return x;
} else {
throw e58195;
...
}catch (e58196){if((e58196 instanceof Error)){
var ___$1 = e58196;
return x;
} else {
throw e58196;
...
}catch (e58197){if((e58197 instanceof Error)){
var ___$1 = e58197;
return x;
} else {
throw e58197;
...
}catch (e58203){if((e58203 instanceof Error)){
var ___$1 = e58203;
return x;
} else {
throw e58203;
...
}catch (e58205){if((e58205 instanceof Error)){
var ___$1 = e58205;
return x;
} else {
throw e58205;
...
spec_tools.transform.strip_extra_keys = (function spec_tools$transform$strip_extra_keys(p__58219,x){
var map__58224 = p__58219;
...
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58224__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.fail_on_extra_keys = (function spec_tools$transform$fail_on_extra_keys(p__58229,x){
...
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58230__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.strip_extra_values = (function spec_tools$transform$strip_extra_values(p__58239,x){
...
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58240__$1,new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600));
