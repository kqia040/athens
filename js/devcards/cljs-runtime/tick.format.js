...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__31205 = goog.object.get(JSJodaLocale,"Locale");
if((G__31205 == null)){
return null;
} else {
return goog.object.get(G__31205,"US");
}
}catch (e31204){if((e31204 instanceof Error)){
var e = e31204;
return null;
} else {
throw e31204;
