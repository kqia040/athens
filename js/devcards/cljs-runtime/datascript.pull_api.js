...
var depth = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29943__$1,new cljs.core.Keyword(null,"depth","depth",1768663640));
var seen = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29943__$1,new cljs.core.Keyword(null,"seen","seen",-518999789));
...
var G__29967 = new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame);
var G__29967__$1 = (((G__29967 == null))?null:cljs.core.persistent_BANG_(G__29967));
if((G__29967__$1 == null)){
return null;
} else {
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__29967__$1,key);
}
});
...
datascript.pull_api.pull_recursion_frame = (function datascript$pull_api$pull_recursion_frame(db,p__29983){
var vec__29986 = p__29983;
...
var frame = first__29988;
var frames = seq__29987__$1;
...
var results = (function (){var G__29992 = new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(frame);
if(cljs.core.seq(kvps)){
return cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(G__29992,kvps);
} else {
return G__29992;
}
})();
...
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30011__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30011__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
var pattern_30247 = (new datascript.pull_parser.PullSpec(true,cljs.core.PersistentArrayMap.EMPTY,null,null,null));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(datascript.pull_api.subpattern_frame(pattern_30247,eids,multi_QMARK_,attr_key),new cljs.core.Keyword(null,"recursion","recursion",-749738765),rec);
});
datascript.pull_api.pull_attr_datoms = (function datascript$pull_api$pull_attr_datoms(db,attr_key,attr,eid,forward_QMARK_,datoms,opts,p__30066){
var vec__30068 = p__30066;
...
var parent = first__30070;
var frames = seq__30069__$1;
...
var found = cljs.core.not_empty((function (){var G__30079 = datoms;
if(cljs.core.truth_(limit)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.take.cljs$core$IFn$_invoke$arity$1(limit),G__30079);
} else {
return G__30079;
}
})());
...
var as_value = (function (){var G__30096 = datom_val;
if(ref_QMARK_){
return cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__30045_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword("db","id","db/id",-1388397098)],[p1__30045_SHARP_]);
}),G__30096);
} else {
return G__30096;
}
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,cljs.core.update.cljs$core$IFn$_invoke$arity$5(parent,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,(function (){var G__30098 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1(as_value),found);
if(single_QMARK_){
return cljs.core.first(G__30098);
} else {
return G__30098;
}
})()));
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,(function (){var G__30103 = parent;
if(cljs.core.contains_QMARK_(opts,new cljs.core.Keyword(null,"default","default",-1987822328))){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__30103,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,new cljs.core.Keyword(null,"default","default",-1987822328).cljs$core$IFn$_invoke$arity$1(opts));
} else {
return G__30103;
}
})());
...
var vec__30108 = spec;
var attr_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30108,(0),null);
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30108,(1),null);
...
datascript.pull_api.filter_reverse_attrs = cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p__30117){
var vec__30121 = p__30117;
...
datascript.pull_api.pull_expand_reverse_frame = (function datascript$pull_api$pull_expand_reverse_frame(db,p__30135){
...
var frame = first__30138;
var frames = seq__30137__$1;
...
datascript.pull_api.pull_expand_frame = (function datascript$pull_api$pull_expand_frame(db,p__30144){
...
var frame = first__30150;
var frames = seq__30149__$1;
...
var vec__30158 = cljs.core.first(datoms_by_attr);
var attr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30158,(0),null);
var datoms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30158,(1),null);
...
var map__30165 = frame;
var map__30165__$1 = (((((!((map__30165 == null))))?(((((map__30165.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__30165.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__30165):map__30165);
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30165__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30165__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var rec = (function (){var G__30170 = recursion;
if((!((attr == null)))){
return datascript.pull_api.push_recursion(G__30170,attr,eid);
} else {
return G__30170;
}
})();
...
var map__30172 = frame;
var map__30172__$1 = (((((!((map__30172 == null))))?(((((map__30172.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__30172.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__30172):map__30172);
var eid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30172__$1,new cljs.core.Keyword(null,"eid","eid",559519930));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30172__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
datascript.pull_api.pull_pattern_frame = (function datascript$pull_api$pull_pattern_frame(db,p__30175){
while(true){
var vec__30176 = p__30175;
var seq__30177 = cljs.core.seq(vec__30176);
var first__30178 = cljs.core.first(seq__30177);
var seq__30177__$1 = cljs.core.next(seq__30177);
var frame = first__30178;
var frames = seq__30177__$1;
var temp__5733__auto__ = cljs.core.seq(new cljs.core.Keyword(null,"eids","eids",1546550700).cljs$core$IFn$_invoke$arity$1(frame));
if(temp__5733__auto__){
var eids = temp__5733__auto__;
...
var G__30340 = db;
var G__30341 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,datascript.pull_api.reset_frame(frame,cljs.core.rest(eids),cljs.core.not_empty(cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__30340;
p__30175 = G__30341;
continue;
}
...
while(true){
var G__30185 = new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first(frames));
var G__30185__$1 = (((G__30185 instanceof cljs.core.Keyword))?G__30185.fqn:null);
switch (G__30185__$1) {
case "expand":
var G__30345 = db;
var G__30346 = datascript.pull_api.pull_expand_frame(db,frames);
db = G__30345;
frames = G__30346;
continue;
...
case "expand-rev":
var G__30347 = db;
var G__30348 = datascript.pull_api.pull_expand_reverse_frame(db,frames);
db = G__30347;
frames = G__30348;
continue;
...
case "pattern":
var G__30349 = db;
var G__30350 = datascript.pull_api.pull_pattern_frame(db,frames);
db = G__30349;
frames = G__30350;
continue;
...
case "recursion":
var G__30353 = db;
var G__30354 = datascript.pull_api.pull_recursion_frame(db,frames);
db = G__30353;
frames = G__30354;
continue;
...
break;
case "done":
var vec__30186 = frames;
var seq__30187 = cljs.core.seq(vec__30186);
var first__30188 = cljs.core.first(seq__30187);
var seq__30187__$1 = cljs.core.next(seq__30187);
var f = first__30188;
var remaining = seq__30187__$1;
var result = (function (){var G__30189 = cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(f));
if(cljs.core.not(new cljs.core.Keyword(null,"multi?","multi?",-749311069).cljs$core$IFn$_invoke$arity$1(f))){
return cljs.core.first(G__30189);
} else {
return G__30189;
}
})();
...
var G__30362 = db;
var G__30363 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.rest(remaining),(function (){var G__30190 = cljs.core.first(remaining);
if(cljs.core.truth_(result)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__30190,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(f),result);
} else {
return G__30190;
}
})());
...
var eids__$1 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__30191_SHARP_){
return datascript.db.entid_strict(db,p1__30191_SHARP_);
})),eids);
