...
stylefy.impl.styles.create_style_BANG_ = (function stylefy$impl$styles$create_style_BANG_(p__53464,style_created_handler){
...
var style = map__53465__$1;
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53465__$1,new cljs.core.Keyword(null,"props","props",453281727));
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53465__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
var style_css = stylefy.impl.conversion.style__GT_css.cljs$core$IFn$_invoke$arity$1(style);
var G__53473_53602 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"css","css",1135045163),style_css,new cljs.core.Keyword(null,"hash","hash",-13781596),hash], null);
(style_created_handler.cljs$core$IFn$_invoke$arity$1 ? style_created_handler.cljs$core$IFn$_invoke$arity$1(G__53473_53602) : style_created_handler.call(null,G__53473_53602));

var seq__53474 = cljs.core.seq(cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(props)));
var chunk__53475 = null;
var count__53476 = (0);
var i__53477 = (0);
while(true){
if((i__53477 < count__53476)){
var sub_style = chunk__53475.cljs$core$IIndexed$_nth$arity$2(null,i__53477);
var G__53496_53605 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__53497_53606 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__53496_53605,G__53497_53606) : stylefy.impl.styles.create_style_BANG_.call(null,G__53496_53605,G__53497_53606));


var G__53608 = seq__53474;
var G__53609 = chunk__53475;
var G__53610 = count__53476;
var G__53611 = (i__53477 + (1));
seq__53474 = G__53608;
chunk__53475 = G__53609;
count__53476 = G__53610;
i__53477 = G__53611;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__53474);
if(temp__5735__auto__){
var seq__53474__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__53474__$1)){
var c__4556__auto__ = cljs.core.chunk_first(seq__53474__$1);
var G__53612 = cljs.core.chunk_rest(seq__53474__$1);
var G__53613 = c__4556__auto__;
var G__53614 = cljs.core.count(c__4556__auto__);
var G__53615 = (0);
seq__53474 = G__53612;
chunk__53475 = G__53613;
count__53476 = G__53614;
i__53477 = G__53615;
continue;
} else {
var sub_style = cljs.core.first(seq__53474__$1);
var G__53498_53616 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__53499_53617 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__53498_53616,G__53499_53617) : stylefy.impl.styles.create_style_BANG_.call(null,G__53498_53616,G__53499_53617));


var G__53618 = cljs.core.next(seq__53474__$1);
var G__53619 = null;
var G__53620 = (0);
var G__53621 = (0);
seq__53474 = G__53618;
chunk__53475 = G__53619;
count__53476 = G__53620;
i__53477 = G__53621;
continue;
}
} else {
...
if((((class$ == null)) || (typeof class$ === 'string') || ((class$ instanceof cljs.core.Keyword)) || (((cljs.core.vector_QMARK_(class$)) && (cljs.core.every_QMARK_((function (p1__53504_SHARP_){
return ((typeof p1__53504_SHARP_ === 'string') || ((p1__53504_SHARP_ instanceof cljs.core.Keyword)) || ((p1__53504_SHARP_ == null)));
}),class$)))))){
return null;
} else {
throw (new Error(["Assert failed: ",["Unsupported ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(origin)," type. It should be nil, keyword, string or vector of strings/keywords). Got: ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([class$], 0))].join(''),"\n","(or (nil? class) (string? class) (keyword? class) (and (vector? class) (every? (fn* [p1__53504#] (or (string? p1__53504#) (keyword? p1__53504#) (nil? p1__53504#))) class)))"].join('')));
}
});
/**
...
var len__4736__auto___53640 = arguments.length;
var i__4737__auto___53641 = (0);
while(true){
if((i__4737__auto___53641 < len__4736__auto___53640)){
args__4742__auto__.push((arguments[i__4737__auto___53641]));

var G__53643 = (i__4737__auto___53641 + (1));
i__4737__auto___53641 = G__53643;
continue;
} else {
}
break;
...
var resolved_sub_style = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__53555_SHARP_,p2__53556_SHARP_){
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(p1__53555_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432),p2__53556_SHARP_], null));
}),style,sub_styles);
if(cljs.core.truth_(resolved_sub_style)){
...
/** @this {Function} */
(stylefy.impl.styles.sub_style.cljs$lang$applyTo = (function (seq53557){
var G__53559 = cljs.core.first(seq53557);
var seq53557__$1 = cljs.core.next(seq53557);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__53559,seq53557__$1);
}));
...
(stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2 = (function (styles,p__53575){
...
var request_dom_update_after_done_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53576__$1,new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510));
var styles_53651__$1 = cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,styles);
var seq__53581_53652 = cljs.core.seq(styles_53651__$1);
var chunk__53582_53653 = null;
var count__53583_53654 = (0);
var i__53584_53655 = (0);
while(true){
if((i__53584_53655 < count__53583_53654)){
var style_53657 = chunk__53582_53653.cljs$core$IIndexed$_nth$arity$2(null,i__53584_53655);
stylefy.impl.styles.use_style_BANG_(style_53657,cljs.core.PersistentArrayMap.EMPTY,stylefy.impl.dom.save_style_BANG_);

var temp__5735__auto___53658 = cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(style_53657));
if(cljs.core.truth_(temp__5735__auto___53658)){
var sub_styles_53661 = temp__5735__auto___53658;
stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2(sub_styles_53661,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510),false], null));
} else {
}


var G__53662 = seq__53581_53652;
var G__53663 = chunk__53582_53653;
var G__53664 = count__53583_53654;
var G__53665 = (i__53584_53655 + (1));
seq__53581_53652 = G__53662;
chunk__53582_53653 = G__53663;
count__53583_53654 = G__53664;
i__53584_53655 = G__53665;
continue;
} else {
var temp__5735__auto___53666 = cljs.core.seq(seq__53581_53652);
if(temp__5735__auto___53666){
var seq__53581_53668__$1 = temp__5735__auto___53666;
if(cljs.core.chunked_seq_QMARK_(seq__53581_53668__$1)){
var c__4556__auto___53669 = cljs.core.chunk_first(seq__53581_53668__$1);
var G__53670 = cljs.core.chunk_rest(seq__53581_53668__$1);
var G__53671 = c__4556__auto___53669;
var G__53672 = cljs.core.count(c__4556__auto___53669);
var G__53673 = (0);
seq__53581_53652 = G__53670;
chunk__53582_53653 = G__53671;
count__53583_53654 = G__53672;
i__53584_53655 = G__53673;
continue;
} else {
var style_53674 = cljs.core.first(seq__53581_53668__$1);
stylefy.impl.styles.use_style_BANG_(style_53674,cljs.core.PersistentArrayMap.EMPTY,stylefy.impl.dom.save_style_BANG_);

var temp__5735__auto___53675__$1 = cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(style_53674));
if(cljs.core.truth_(temp__5735__auto___53675__$1)){
var sub_styles_53676 = temp__5735__auto___53675__$1;
stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2(sub_styles_53676,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510),false], null));
} else {
}


var G__53677 = cljs.core.next(seq__53581_53668__$1);
var G__53678 = null;
var G__53679 = (0);
var G__53680 = (0);
seq__53581_53652 = G__53677;
chunk__53582_53653 = G__53678;
count__53583_53654 = G__53679;
i__53584_53655 = G__53680;
continue;
}
} else {
}
