...
var G__30589 = o;
goog.object.set(G__30589,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__30595 = o;
goog.object.set(G__30595,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__30746__i < G__30746__a.length) {G__30746__a[G__30746__i] = arguments[G__30746__i + 0]; ++G__30746__i;}
  args = new cljs.core.IndexedSeq(G__30746__a,0,null);
} 
...
var G__30602 = props;
var G__30602__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__30602,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__30602);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__30602__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__30602__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__30605 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__30605,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__30605;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__30615){
var map__30616 = p__30615;
var map__30616__$1 = (((((!((map__30616 == null))))?(((((map__30616.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__30616.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__30616):map__30616);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30616__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__30625_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__30625_SHARP_);
}));
} else {
return null;
}
...
var vec__30630 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30630,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30630,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30630,(2),null);
...
var temp__5739__auto___30781 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___30781 == null)){
} else {
var key_30782 = temp__5739__auto___30781;
(jsprops.key = key_30782);
}
...
var temp__5739__auto___30783 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___30783 == null)){
} else {
var key_30784 = temp__5739__auto___30783;
(jsprops.key = key_30784);
}
...
var G__30653 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__30653) : reagent.impl.template.as_element.call(null,G__30653));
} else {
var temp__5739__auto___30789 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5739__auto___30789 == null)){
} else {
var key_30790 = temp__5739__auto___30789;
(jsprops.key = key_30790);
}
...
var G__30661 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__30661)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__30661)){
return x;
} else {
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq30662){
var G__30663 = cljs.core.first(seq30662);
var seq30662__$1 = cljs.core.next(seq30662);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30663,seq30662__$1);
}));
...
break;
default:
var G__30806 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__30806;
continue;
...
var ctx = ({});
var vec__30674 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30674,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30674,(1),null);
...
var G__30683 = (cljs.core.count(argv) - first_child);
switch (G__30683) {
case (0):
