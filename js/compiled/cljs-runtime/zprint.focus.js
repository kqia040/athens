...
var G__27791 = new_next_nonws_QMARK_;
index = G__27789;
skip_to_right_QMARK_ = G__27790;
next_nonws_QMARK_ = G__27791;
continue;
}
}
break;
...
var G__27796 = zprint.focus.next_ssv(ssv,index);
var G__27797 = (moves - (1));
index = G__27796;
moves = G__27797;
continue;
}
...
var G__27801 = zprint.focus.right_ssv(cljs.core.first(nwp),ssv,zprint.focus.down_ssv(ssv,idx));
var G__27802 = cljs.core.next(nwp);
idx = G__27801;
nwp = G__27802;
continue;
}
