...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq21196){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21197,G__21198,seq21196__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__21219_SHARP_){
return (!((cljs.core.meta(p1__21219_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21225__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e21229){var _e__19985__auto__ = e21229;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e21231){var _e__19985__auto__ = e21231;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__21233 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__21234 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__21234);

try{var map__21235 = opts;
var map__21235__$1 = (((((!((map__21235 == null))))?(((((map__21235.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__21235.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__21235):map__21235);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21235__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__21233);
}});
...
var temp__5733__auto___21257 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___21257)){
var managed_print_level_21258 = temp__5733__auto___21257;
var _STAR_print_level_STAR__orig_val__21239_21259 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__21240_21260 = managed_print_level_21258;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__21240_21260);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__21237_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__21237_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__21239_21259);
}} else {
job_fn();
}
