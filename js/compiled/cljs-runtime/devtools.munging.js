...
var temp__5733__auto____$1 = (o20839["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o20840 = temp__5733__auto____$1;
return (o20840["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__20309__auto__ = f;
return (o__20309__auto__["toString"]).call(o__20309__auto__);
} else {
return "";
}
}catch (e20841){var _ = e20841;
return "";
}});
...
try{var o__20309__auto___21152 = t;
(o__20309__auto___21152["cljs$lang$ctorPrWriter"]).call(o__20309__auto___21152,t,writer);
}catch (e20853){var __21153 = e20853;
}
...
var char_code = (function (){var o__20309__auto__ = (new String(char$));
return (o__20309__auto__["charCodeAt"]).call(o__20309__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__20309__auto__ = String;
return (o__20309__auto__["fromCharCode"]).call(o__20309__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__20881 = num_code;
switch (G__20881) {
case (1):
return (185);
...
var o__20309__auto__ = String;
return (o__20309__auto__["fromCharCode"]).call(o__20309__auto__,superscript_code);
});
/**
...
}catch (e20904){var _e__20352__auto__ = e20904;
return false;
}})())){
...
var vec__20909 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20909,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o20918 = temp__5733__auto__;
var temp__5733__auto____$1 = (o20918["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o20919 = temp__5733__auto____$1;
return (o20919["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4736__auto___21177 = arguments.length;
var i__4737__auto___21178 = (0);
while(true){
if((i__4737__auto___21178 < len__4736__auto___21177)){
args__4742__auto__.push((arguments[i__4737__auto___21178]));

var G__21180 = (i__4737__auto___21178 + (1));
i__4737__auto___21178 = G__21180;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__20927){
var vec__20928 = p__20927;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20928,(0),null);
...
var G__21182 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__21183 = cljs.core.butlast(remaining_tokens);
name_tokens = G__21182;
remaining_tokens = G__21183;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq20925){
var G__20926 = cljs.core.first(seq20925);
var seq20925__$1 = cljs.core.next(seq20925);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20926,seq20925__$1);
}));
...
var vec__20945 = cljs.core.split_with((function (p1__20938_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__20938_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20945,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20945,(1),null);
...
var vec__20955 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20955,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20955,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__21187 = cljs.core.rest(remaining_tokens);
var G__21188 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__21187;
name_tokens = G__21188;
continue;
} else {
...
var vec__20967 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20967,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20967,(1),null);
var vec__20970 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20970,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20970,(1),null);
var vec__20973 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20973,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20973,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20973,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20973,(3),null);
...
var vec__20995 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20995,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20995,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20995,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20995,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20995,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20995,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__21009 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21009,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21009,(1),null);
var vec__21017 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21017,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21017,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__21031 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__21031) : devtools.munging.parse_fn_info_deep.call(null,G__21031));
})()));
}
} else {
return fn_info;
...
var G__21203 = (arity + (1));
var G__21204 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__21051){
var vec__21052 = p__21051;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21052,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21052,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__21059_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__21059_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__21060_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__21060_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___21210 = arguments.length;
var i__4737__auto___21211 = (0);
while(true){
if((i__4737__auto___21211 < len__4736__auto___21210)){
args__4742__auto__.push((arguments[i__4737__auto___21211]));

var G__21212 = (i__4737__auto___21211 + (1));
i__4737__auto___21211 = G__21212;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__21068){
var vec__21069 = p__21068;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21069,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq21066){
var G__21067 = cljs.core.first(seq21066);
var seq21066__$1 = cljs.core.next(seq21066);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21067,seq21066__$1);
}));
...
var map__21093 = options;
var map__21093__$1 = (((((!((map__21093 == null))))?(((((map__21093.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__21093.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__21093):map__21093);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21093__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21093__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21093__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21093__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__21094 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21094,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21094,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21094,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21094,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21094,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21094,(5),null);
...
var o__20309__auto__ = f;
return (o__20309__auto__["getBasis"]).call(o__20309__auto__);
});
/**
...
}catch (e21104){var _e__20352__auto__ = e21104;
...
var G__21226 = (obj[cljs.core.first(path)]);
var G__21227 = cljs.core.rest(path);
obj = G__21226;
path = G__21227;
continue;
} else {
...
var _STAR_ = (function (accum,p__21123){
var vec__21124 = p__21123;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21124,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21124,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__21129){
var vec__21130 = p__21129;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21130,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21130,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21130,(2),null);
...
var post_process = (function (p__21140){
var vec__21141 = p__21140;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21141,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21141,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__21138_SHARP_){
return (obj[cljs.core.first(p1__21138_SHARP_)]);
}),sorted_matches);
