...
var vec__57422 = cljs.core.rest(expr);
var seq__57423 = cljs.core.seq(vec__57422);
var first__57424 = cljs.core.first(seq__57423);
var seq__57423__$1 = cljs.core.next(seq__57423);
var vec__57425 = first__57424;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57425,(0),null);
var form = seq__57423__$1;
...
var G__57434 = x;
var G__57434__$1 = (((G__57434 == null))?null:spec_tools.impl.polish(G__57434));
var G__57434__$2 = (((G__57434__$1 == null))?null:cljs.core.name(G__57434__$1));
if((G__57434__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__57434__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__57441 = x;
var G__57441__$1 = (((G__57441 == null))?null:cljs.core.name(G__57441));
if((G__57441__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__57441__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__57446){
...
var data = map__57447__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57447__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57447__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57447__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57447__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__57449){
var map__57450 = p__57449;
...
var data = map__57450__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57450__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57450__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__57452 = data;
var G__57452__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__57452,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__57452);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__57452__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__57452__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__57456 = form;
var G__57456__$1 = (((G__57456 == null))?null:cljs.core.rest(G__57456));
if((G__57456__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__57456__$1);
}
})();
var G__57457 = m;
var G__57457__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__57457,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__57453_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__57453_SHARP_)));
})):G__57457);
var G__57457__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__57457__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__57454_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__57454_SHARP_)));
})):G__57457__$1);
var G__57457__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__57457__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__57455_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__57455_SHARP_));
})):G__57457__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__57457__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__57458 = (function (){var G__57459 = form;
var G__57459__$1 = (((G__57459 == null))?null:cljs.core.rest(G__57459));
if((G__57459__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__57459__$1);
}
})();
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57458__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57458__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57458__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57458__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__57469 = (((kw instanceof cljs.core.Symbol))?cljs.core.namespace(kw):false);
switch (G__57469) {
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__57476 = form;
var G__57476__$1 = (((G__57476 == null))?null:cljs.core.seq(G__57476));
var G__57476__$2 = (((G__57476__$1 == null))?null:cljs.core.first(G__57476__$1));
if((G__57476__$2 == null)){
return null;
} else {
var fexpr__57478 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__57478.cljs$core$IFn$_invoke$arity$1 ? fexpr__57478.cljs$core$IFn$_invoke$arity$1(G__57476__$2) : fexpr__57478.call(null,G__57476__$2));
}
})():null));
});
/**
...
var len__4736__auto___57571 = arguments.length;
var i__4737__auto___57572 = (0);
while(true){
if((i__4737__auto___57572 < len__4736__auto___57571)){
args__4742__auto__.push((arguments[i__4737__auto___57572]));

var G__57573 = (i__4737__auto___57572 + (1));
i__4737__auto___57572 = G__57573;
continue;
} else {
}
break;
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq57481){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq57481));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__57492){
var vec__57493 = p__57492;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57493,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57493,(1),null);
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__57504){
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57505__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57505__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57505__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57505__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__57502_SHARP_){
return cljs.core.map_QMARK_(p1__57502_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__57503_SHARP_){
return cljs.core.contains_QMARK_(p1__57503_SHARP_,x);
});
}),req_keys));
