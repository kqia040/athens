...
return [(function (){var pred__26814 = cljs.core.instance_QMARK_;
var expr__26815 = reactive_val;
if(cljs.core.truth_((pred__26814.cljs$core$IFn$_invoke$arity$2 ? pred__26814.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.RAtom,expr__26815) : pred__26814.call(null,day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.RAtom,expr__26815)))){
return "ra";
} else {
if(cljs.core.truth_((pred__26814.cljs$core$IFn$_invoke$arity$2 ? pred__26814.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.RCursor,expr__26815) : pred__26814.call(null,day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.RCursor,expr__26815)))){
return "rc";
} else {
if(cljs.core.truth_((pred__26814.cljs$core$IFn$_invoke$arity$2 ? pred__26814.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.Reaction,expr__26815) : pred__26814.call(null,day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.Reaction,expr__26815)))){
return "rx";
} else {
if(cljs.core.truth_((pred__26814.cljs$core$IFn$_invoke$arity$2 ? pred__26814.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.Track,expr__26815) : pred__26814.call(null,day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.Track,expr__26815)))){
return "tr";
} else {
return "other";
}
