...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"navigate","navigate",657596805),(function (_,p__55078){
var vec__55080 = p__55078;
var seq__55081 = cljs.core.seq(vec__55080);
var first__55082 = cljs.core.first(seq__55081);
var seq__55081__$1 = cljs.core.next(seq__55081);
var ___$1 = first__55082;
var route = seq__55081__$1;
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"navigated","navigated",540897836),(function (p__55083,p__55084){
var map__55085 = p__55083;
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55085__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__55086 = p__55084;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55086,(0),null);
var new_match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55086,(1),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("local-storage","navigate","local-storage/navigate",-707087458),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_frame.core.inject_cofx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"local-storage","local-storage",-1301104068),"current-route/uid")], null),(function (p__55092,_){
var map__55093 = p__55092;
...
var local_storage = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55093__$1,new cljs.core.Keyword(null,"local-storage","local-storage",-1301104068));
...
var result__51723__auto__ = cljs.core.apply.cljs$core$IFn$_invoke$arity$2((function (){var opts__51722__auto____$1 = _PLUS_debux_dbg_opts_PLUS_;
var result__51723__auto__ = reitit.frontend.easy.push_state;
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"result","result",1415092211),result__51723__auto__,new cljs.core.Keyword(null,"form","form",-1624062471),new cljs.core.Symbol("rfee","push-state","rfee/push-state",305346137,null),new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),(1)], null));

return result__51723__auto__;
})(),(function (){var opts__51722__auto____$1 = _PLUS_debux_dbg_opts_PLUS_;
var result__51723__auto__ = route;
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"result","result",1415092211),result__51723__auto__,new cljs.core.Keyword(null,"form","form",-1624062471),new cljs.core.Symbol(null,"route","route",1970422836,null),new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),(1)], null));

return result__51723__auto__;
})());
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"result","result",1415092211),result__51723__auto__,new cljs.core.Keyword(null,"form","form",-1624062471),cljs.core.list(new cljs.core.Symbol(null,"apply","apply",-1334050276,null),new cljs.core.Symbol("rfee","push-state","rfee/push-state",305346137,null),new cljs.core.Symbol(null,"route","route",1970422836,null)),new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),(0)], null));

return result__51723__auto__;
}catch (e55096){var e = e55096;
throw e;
}}):(function (route){
