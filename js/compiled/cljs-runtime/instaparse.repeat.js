...
var vec__53802 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53802,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53802,(1),null);
...
var vec__53806 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53806,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53806,(1),null);
if(cljs.core.truth_(end)){
return cljs.core.long$(end);
} else {
...
var vec__53818 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53818,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53818,(1),null);
...
var G__54033 = cljs.core.next(parses__$1);
parses__$1 = G__54033;
continue;
}
...
var G__53839 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__53840 = G__53839;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53840,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53840,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53840,(2),null);
var selection = vec__53840;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__53839__$1 = G__53839;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__53858 = G__53839__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53858,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53858,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53858,(2),null);
var selection__$1 = vec__53858;
...
var G__54066 = cljs.core.long$(end__$1);
var G__54067 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__54068 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__54066;
parses__$1 = G__54067;
G__53839__$1 = G__54068;
continue;
...
var G__53884 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__53886 = G__53884;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53886,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53886,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53886,(2),null);
var selection = vec__53886;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__53884__$1 = G__53884;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__53902 = G__53884__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53902,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53902,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53902,(2),null);
var selection__$1 = vec__53902;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__54097 = cljs.core.long$(end__$1);
var G__54098 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__54099 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__54097;
parses__$1 = G__54098;
G__53884__$1 = G__54099;
continue;
...
var index__$1 = cljs.core.long$(index);
var parses = instaparse.auto_flatten_seq.EMPTY;
var G__53926 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__53928 = G__53926;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53928,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53928,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53928,(2),null);
var selection = vec__53928;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__53926__$1 = G__53926;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__53942 = G__53926__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53942,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53942,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53942,(2),null);
var selection__$1 = vec__53942;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__54124 = cljs.core.long$(end__$1);
var G__54126 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__54127 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__54124;
parses__$1 = G__54126;
G__53926__$1 = G__54127;
continue;
...
if(cljs.core.truth_((function (){var fexpr__53955 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__53955.cljs$core$IFn$_invoke$arity$1 ? fexpr__53955.cljs$core$IFn$_invoke$arity$1(output_format) : fexpr__53955.call(null,output_format));
})())){
} else {
...
if(cljs.core.not(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(start_rule),new cljs.core.Keyword(null,"cat","cat",-1457810207)))?(function (){var and__4115__auto__ = (function (){var G__53983 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(repeating_parser);
var fexpr__53982 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"star","star",279424429),null,new cljs.core.Keyword(null,"plus","plus",211540661),null], null), null);
return (fexpr__53982.cljs$core$IFn$_invoke$arity$1 ? fexpr__53982.cljs$core$IFn$_invoke$arity$1(G__53983) : fexpr__53982.call(null,G__53983));
})();
