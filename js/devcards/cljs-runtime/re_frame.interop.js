...
return [(function (){var pred__47740 = cljs.core.instance_QMARK_;
var expr__47741 = reactive_val;
if(cljs.core.truth_((pred__47740.cljs$core$IFn$_invoke$arity$2 ? pred__47740.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__47741) : pred__47740.call(null,reagent.ratom.RAtom,expr__47741)))){
return "ra";
} else {
if(cljs.core.truth_((pred__47740.cljs$core$IFn$_invoke$arity$2 ? pred__47740.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__47741) : pred__47740.call(null,reagent.ratom.RCursor,expr__47741)))){
return "rc";
} else {
if(cljs.core.truth_((pred__47740.cljs$core$IFn$_invoke$arity$2 ? pred__47740.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__47741) : pred__47740.call(null,reagent.ratom.Reaction,expr__47741)))){
return "rx";
} else {
if(cljs.core.truth_((pred__47740.cljs$core$IFn$_invoke$arity$2 ? pred__47740.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__47741) : pred__47740.call(null,reagent.ratom.Track,expr__47741)))){
return "tr";
} else {
return "other";
}
