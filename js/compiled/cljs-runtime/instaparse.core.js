...
if(cljs.core.truth_((function (){var fexpr__55484 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__55484.cljs$core$IFn$_invoke$arity$1 ? fexpr__55484.cljs$core$IFn$_invoke$arity$1(type) : fexpr__55484.call(null,type));
})())){
} else {
...
if(cljs.core.truth_((function (){var fexpr__55485 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ebnf","ebnf",31967825),null,new cljs.core.Keyword(null,"abnf","abnf",-152462052),null], null), null);
return (fexpr__55485.cljs$core$IFn$_invoke$arity$1 ? fexpr__55485.cljs$core$IFn$_invoke$arity$1(type) : fexpr__55485.call(null,type));
})())){
} else {
...
var G__55491 = unhide;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__55491)){
return parser;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"content","content",15833224),G__55491)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tags","tags",1771418977),G__55491)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"all","all",892129742),G__55491)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__55491)].join('')));
...
var len__4736__auto___55744 = arguments.length;
var i__4737__auto___55745 = (0);
while(true){
if((i__4737__auto___55745 < len__4736__auto___55744)){
args__4742__auto__.push((arguments[i__4737__auto___55745]));

var G__55746 = (i__4737__auto___55745 + (1));
i__4737__auto___55745 = G__55746;
continue;
} else {
}
break;
...
(instaparse.core.parse.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__55500){
...
return instaparse.gll.parse_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__55511 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__55511) : instaparse.reduction.node_builders.call(null,G__55511));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parse.cljs$lang$applyTo = (function (seq55497){
var G__55498 = cljs.core.first(seq55497);
var seq55497__$1 = cljs.core.next(seq55497);
var G__55499 = cljs.core.first(seq55497__$1);
var seq55497__$2 = cljs.core.next(seq55497__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__55498,G__55499,seq55497__$2);
}));
...
var args__4742__auto__ = [];
var len__4736__auto___55764 = arguments.length;
var i__4737__auto___55765 = (0);
while(true){
if((i__4737__auto___55765 < len__4736__auto___55764)){
args__4742__auto__.push((arguments[i__4737__auto___55765]));

var G__55766 = (i__4737__auto___55765 + (1));
i__4737__auto___55765 = G__55766;
continue;
} else {
}
break;
...
(instaparse.core.parses.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__55519){
...
var parser__$1 = instaparse.core.unhide_parser(parser,unhide);
if(cljs.core.truth_(new cljs.core.Keyword(null,"total","total",1916810418).cljs$core$IFn$_invoke$arity$1(options))){
return instaparse.gll.parses_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__55525 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__55525) : instaparse.reduction.node_builders.call(null,G__55525));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parses.cljs$lang$applyTo = (function (seq55516){
...
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__55517,G__55518,seq55516__$2);
}));
...
(instaparse.core.Parser.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k55531,else__4383__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k55531,else__4383__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__55537){
var vec__55538 = p__55537;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55538,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55538,(1),null);
...
(instaparse.core.Parser.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__55530){
var self__ = this;
...
(instaparse.core.Parser.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this55532,other55533){
var self__ = this;
var this55532__$1 = this;
return (((!((other55533 == null)))) && ((this55532__$1.constructor === other55533.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this55532__$1.grammar,other55533.grammar)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this55532__$1.start_production,other55533.start_production)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this55532__$1.output_format,other55533.output_format)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this55532__$1.__extmap,other55533.__extmap)));
}));
...
(instaparse.core.Parser.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__55530){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__55556 = cljs.core.keyword_identical_QMARK_;
var expr__55557 = k__4388__auto__;
if(cljs.core.truth_((pred__55556.cljs$core$IFn$_invoke$arity$2 ? pred__55556.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"grammar","grammar",1881328267),expr__55557) : pred__55556.call(null,new cljs.core.Keyword(null,"grammar","grammar",1881328267),expr__55557)))){
return (new instaparse.core.Parser(G__55530,self__.start_production,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__55556.cljs$core$IFn$_invoke$arity$2 ? pred__55556.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"start-production","start-production",687546537),expr__55557) : pred__55556.call(null,new cljs.core.Keyword(null,"start-production","start-production",687546537),expr__55557)))){
return (new instaparse.core.Parser(self__.grammar,G__55530,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__55556.cljs$core$IFn$_invoke$arity$2 ? pred__55556.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"output-format","output-format",-1826382676),expr__55557) : pred__55556.call(null,new cljs.core.Keyword(null,"output-format","output-format",-1826382676),expr__55557)))){
return (new instaparse.core.Parser(self__.grammar,self__.start_production,G__55530,self__.__meta,self__.__extmap,null));
} else {
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__55530),null));
}
}
}
}));
...
(instaparse.core.Parser.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__55530){
var self__ = this;
var this__4379__auto____$1 = this;
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,G__55530,self__.__extmap,self__.__hash));
}));
...
var self__ = this;
var self__ = this;
var G__55565 = (arguments.length - (1));
switch (G__55565) {
case (1):
...
(instaparse.core.Parser.prototype.apply = (function (self__,args55535){
var self__ = this;
var self____$1 = this;
 ...
 */
instaparse.core.map__GT_Parser = (function instaparse$core$map__GT_Parser(G__55534){
var extmap__4419__auto__ = (function (){var G__55628 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__55534,new cljs.core.Keyword(null,"grammar","grammar",1881328267),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"start-production","start-production",687546537),new cljs.core.Keyword(null,"output-format","output-format",-1826382676)], 0));
if(cljs.core.record_QMARK_(G__55534)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__55628);
} else {
return G__55628;
}
})();
return (new instaparse.core.Parser(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(G__55534),new cljs.core.Keyword(null,"start-production","start-production",687546537).cljs$core$IFn$_invoke$arity$1(G__55534),new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(G__55534),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
...
(instaparse.core.parser.cljs$core$IFn$_invoke$arity$variadic = (function (grammar_specification,p__55646){
var map__55647 = p__55646;
var map__55647__$1 = (((((!((map__55647 == null))))?(((((map__55647.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__55647.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__55647):map__55647);
var options = map__55647__$1;
...
var _STAR_case_insensitive_literals_STAR__orig_val__55673 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__55674 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(options,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__55674);

try{var G__55677 = input_format;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__55677__$1)].join('')));

}
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__55673);
}});
...
var map__55694 = temp__5733__auto__;
...
var ws_grammar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55694__$1,new cljs.core.Keyword(null,"grammar","grammar",1881328267));
var ws_start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55694__$1,new cljs.core.Keyword(null,"start-production","start-production",687546537));
...
/** @this {Function} */
(instaparse.core.parser.cljs$lang$applyTo = (function (seq55630){
var G__55631 = cljs.core.first(seq55630);
var seq55630__$1 = cljs.core.next(seq55630);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__55631,seq55630__$1);
}));
