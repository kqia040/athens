...
}catch (e20917){var _e = e20917;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___21033 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___21033)){
var seen_errors_21034 = temp__5733__auto___21033;
if(cljs.core.truth_(seen_errors_21034.has(self))){
} else {
seen_errors_21034.add(self);

var temp__5735__auto___21035 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___21035)){
var sense_21036 = temp__5735__auto___21035;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_21036)].join(''));
} else {
}
}
} else {
