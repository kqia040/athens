...
var vec__56190 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56190,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56190,(1),null);
...
var vec__56193 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56193,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56193,(1),null);
if(cljs.core.truth_(end)){
return cljs.core.long$(end);
} else {
...
var vec__56210 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56210,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56210,(1),null);
...
var G__56414 = cljs.core.next(parses__$1);
parses__$1 = G__56414;
continue;
}
...
var G__56229 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__56230 = G__56229;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56230,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56230,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56230,(2),null);
var selection = vec__56230;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__56229__$1 = G__56229;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__56243 = G__56229__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56243,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56243,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56243,(2),null);
var selection__$1 = vec__56243;
...
var G__56443 = cljs.core.long$(end__$1);
var G__56444 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__56445 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__56443;
parses__$1 = G__56444;
G__56229__$1 = G__56445;
continue;
...
var G__56265 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__56269 = G__56265;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56269,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56269,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56269,(2),null);
var selection = vec__56269;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__56265__$1 = G__56265;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__56278 = G__56265__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56278,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56278,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56278,(2),null);
var selection__$1 = vec__56278;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__56459 = cljs.core.long$(end__$1);
var G__56460 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__56461 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__56459;
parses__$1 = G__56460;
G__56265__$1 = G__56461;
continue;
...
var index__$1 = cljs.core.long$(index);
var parses = instaparse.auto_flatten_seq.EMPTY;
var G__56304 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__56305 = G__56304;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56305,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56305,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56305,(2),null);
var selection = vec__56305;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__56304__$1 = G__56304;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__56314 = G__56304__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56314,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56314,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56314,(2),null);
var selection__$1 = vec__56314;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__56486 = cljs.core.long$(end__$1);
var G__56487 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__56488 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__56486;
parses__$1 = G__56487;
G__56304__$1 = G__56488;
continue;
...
if(cljs.core.truth_((function (){var fexpr__56327 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__56327.cljs$core$IFn$_invoke$arity$1 ? fexpr__56327.cljs$core$IFn$_invoke$arity$1(output_format) : fexpr__56327.call(null,output_format));
})())){
} else {
...
var G__56342 = output_format;
var G__56342__$1 = (((G__56342 instanceof cljs.core.Keyword))?G__56342.fqn:null);
switch (G__56342__$1) {
case "enlive":
...
if(cljs.core.not(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(start_rule),new cljs.core.Keyword(null,"cat","cat",-1457810207)))?(function (){var and__4115__auto__ = (function (){var G__56365 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(repeating_parser);
var fexpr__56364 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"star","star",279424429),null,new cljs.core.Keyword(null,"plus","plus",211540661),null], null), null);
return (fexpr__56364.cljs$core$IFn$_invoke$arity$1 ? fexpr__56364.cljs$core$IFn$_invoke$arity$1(G__56365) : fexpr__56364.call(null,G__56365));
})();
