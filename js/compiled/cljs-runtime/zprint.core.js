...
var vec__34196 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [zprint.core.get_zipper(options,coll),options], null):(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__34201 = zprint.zutil.find_root_and_path_nw(coll);
var root = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34201,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34201,(1),null);
...
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34196,(0),null);
var options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34196,(1),null);
 ...
 */
zprint.core.process_rest_options = (function zprint$core$process_rest_options(internal_options,p__34206){
var vec__34207 = p__34206;
var width_or_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34207,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34207,(1),null);
...
var width_or_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34212,(0),null);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34212,(1),null);
...
var vec__34218 = zprint.config.perform_remove(null,null,zprint.config.get_options(),rest_options);
var internal_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34218,(0),null);
var rest_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34218,(1),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34218,(2),null);
var vec__34221 = zprint.config.apply_style(null,null,internal_map,rest_options__$1);
var updated_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34221,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34221,(1),null);
var style_errors = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34221,(2),null);
 ...
 */
zprint.core.range_vec = (function zprint$core$range_vec(v,p__34234){
var vec__34236 = p__34234;
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34236,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34236,(1),null);
...
var G__34559 = (i__4737__auto___34549 + (1));
i__4737__auto___34549 = G__34559;
continue;
} else {
}
break;
...
var vec__34243 = zprint.core.process_rest_options(internal_options,rest);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34243,(0),null);
var rest_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34243,(1),null);
...
var G__34247 = zprint.core.parse_string_all_options(rest_options);
var G__34248 = zprint.core.zprint_str_internal;
var G__34249 = ":parse-string-all? call";
var G__34250 = (function (){var G__34252 = rewrite_clj.parser.parse_string_all(coll);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__34252) : zprint.zutil.edn_STAR_.call(null,G__34252));
})();
return (zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4 ? zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4(G__34247,G__34248,G__34249,G__34250) : zprint.core.process_multiple_forms.call(null,G__34247,G__34248,G__34249,G__34250));
} else {
throw (new Error(":parse-string-all? requires a string!"));
}
} else {
var actual_options = zprint.core.determine_options(rest_options);
var vec__34254 = zprint.core.zprint_STAR_(coll,special_option,actual_options);
var cvec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34254,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34254,(1),null);
...
/** @this {Function} */
(zprint.core.zprint_str_internal.cljs$lang$applyTo = (function (seq34240){
var G__34241 = cljs.core.first(seq34240);
var seq34240__$1 = cljs.core.next(seq34240);
var G__34242 = cljs.core.first(seq34240__$1);
var seq34240__$2 = cljs.core.next(seq34240__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__34241,G__34242,seq34240__$2);
}));
...
var i__4737__auto___34610 = (0);
while(true){
if((i__4737__auto___34610 < len__4736__auto___34606)){
args__4742__auto__.push((arguments[i__4737__auto___34610]));

var G__34611 = (i__4737__auto___34610 + (1));
i__4737__auto___34610 = G__34611;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.zprint_str.cljs$lang$applyTo = (function (seq34266){
var G__34267 = cljs.core.first(seq34266);
var seq34266__$1 = cljs.core.next(seq34266);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__34267,seq34266__$1);
}));
...
/** @this {Function} */
(zprint.core.czprint_str.cljs$lang$applyTo = (function (seq34280){
var G__34281 = cljs.core.first(seq34280);
var seq34280__$1 = cljs.core.next(seq34280);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__34281,seq34280__$1);
}));
...
while(true){
if((i__4737__auto___34637 < len__4736__auto___34630)){
...
/** @this {Function} */
(zprint.core.zprint.cljs$lang$applyTo = (function (seq34287){
var G__34288 = cljs.core.first(seq34287);
var seq34287__$1 = cljs.core.next(seq34287);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__34288,seq34287__$1);
}));
...
var args__4742__auto__ = [];
var len__4736__auto___34651 = arguments.length;
var i__4737__auto___34652 = (0);
while(true){
if((i__4737__auto___34652 < len__4736__auto___34651)){
args__4742__auto__.push((arguments[i__4737__auto___34652]));

var G__34653 = (i__4737__auto___34652 + (1));
i__4737__auto___34652 = G__34653;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint.cljs$lang$applyTo = (function (seq34299){
 ...
 */
zprint.core.process_form = (function zprint$core$process_form(rest_options,zprint_fn,zprint_specifier,p__34318,form){
var vec__34323 = p__34318;
var next_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34323,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34323,(1),null);
var indent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34323,(2),null);
var zprint_num = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34323,(3),null);
var comment_QMARK_ = zprint.zutil.zcomment_QMARK_(form);
var whitespace_form_QMARK_ = zprint.zutil.whitespace_QMARK_(form);
var vec__34326 = (cljs.core.truth_((function (){var and__4115__auto__ = comment_QMARK_;
if(cljs.core.truth_(and__4115__auto__)){
if((indent === (0))){
...
var new_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34326,(0),null);
var error_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34326,(1),null);
...
var forms = (function (){var G__34359 = rewrite_clj.parser.parse_string_all(filestring__$1);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__34359) : zprint.zutil.edn_STAR_.call(null,G__34359));
})();
