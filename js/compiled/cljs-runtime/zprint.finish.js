...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__27780_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__27780_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__27780_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__27782){
var vec__27783 = p__27782;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27783,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27783,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__27798,s,color,element,idx){
var map__27799 = p__27798;
var map__27799__$1 = (((((!((map__27799 == null))))?(((((map__27799.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__27799.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__27799):map__27799);
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27799__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27799__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27799__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__27817 = (function (){var or__4126__auto__ = color;
...
var fexpr__27816 = (function (){var G__27818 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__27818) : style_map.call(null,G__27818));
})();
return (fexpr__27816.cljs$core$IFn$_invoke$arity$1 ? fexpr__27816.cljs$core$IFn$_invoke$arity$1(G__27817) : fexpr__27816.call(null,G__27817));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__27823){
var vec__27824 = p__27823;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27824,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27824,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27824,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__27831){
var vec__27833 = p__27831;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27833,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27833,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27833,(2),null);
...
var vec__27857 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27857,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27857,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27857,(2),null);
...
var G__28132 = cljs.core.next(remaining_cvec);
var G__28133 = new_idx;
var G__28134 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__28132;
idx = G__28133;
out = G__28134;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__27906,cursor_vec){
var vec__27907 = p__27906;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27907,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27907,(1),null);
var focus_vec = vec__27907;
...
var vec__27910 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27910,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27910,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__27923){
var vec__27924 = p__27923;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27924,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27924,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__27950,existing_count){
var vec__27951 = p__27950;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27951,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27951,(1),null);
...
return cljs.core.filterv((function (p1__27940_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__27940_SHARP_))));
...
var vec__27996 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27996,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27996,(1),null);
var cvec_element = vec__27996;
if((cvec_element == null)){
var G__28177 = cljs.core.next(cvec_nl);
var G__28178 = (idx + (1));
var G__28179 = start;
var G__28180 = out;
cvec_nl = G__28177;
...
var G__28181 = cljs.core.next(cvec_nl);
var G__28182 = (idx + (1));
var G__28183 = idx;
var G__28184 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__28181;
idx = G__28182;
start = G__28183;
out = G__28184;
...
var G__28187 = cljs.core.next(cvec_nl);
var G__28188 = (idx + (1));
var G__28189 = (idx + (1));
var G__28190 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__28187;
idx = G__28188;
start = G__28189;
out = G__28190;
...
var G__28192 = cljs.core.next(cvec_nl);
var G__28193 = (idx + (1));
var G__28194 = idx;
var G__28195 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__28192;
idx = G__28193;
start = G__28194;
out = G__28195;
...
var G__28198 = cljs.core.next(cvec_nl);
var G__28199 = (idx + (1));
var G__28200 = start;
var G__28201 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__28198;
idx = G__28199;
start = G__28200;
out = G__28201;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__28003_SHARP_,p2__28002_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__28002_SHARP_)){
return cljs.core.reduced(p1__28003_SHARP_);
} else {
return (p1__28003_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__28006,p__28007){
var vec__28012 = p__28006;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28012,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28012,(1),null);
var vec__28015 = p__28007;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28015,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28015,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__28025,cvec,focus_vec){
var map__28026 = p__28025;
var map__28026__$1 = (((((!((map__28026 == null))))?(((((map__28026.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__28026.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__28026):map__28026);
var options = map__28026__$1;
var map__28027 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28026__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
...
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28027__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28027__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28027__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28024_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__28024_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
