...
var G__21200 = devtools.prefs.pref(v);
v = G__21200;
continue;
} else {
return v;
...
}catch (e21163){var _e__20352__auto__ = e21163;
return false;
}})();
...
}catch (e21168){var _e__20352__auto__ = e21168;
return false;
}})();
...
}catch (e21170){var _e__20352__auto__ = e21170;
return false;
}}
}
});
...
var vec__21189 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21189,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21189,(1),null);
...
return cljs.core.some((function (p1__21194_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__21194_SHARP_);
}),template);
});
