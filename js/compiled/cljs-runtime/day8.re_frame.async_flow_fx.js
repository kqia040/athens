 ...
 */
day8.re_frame.async_flow_fx.dissoc_in = (function day8$re_frame$async_flow_fx$dissoc_in(m,p__54757){
var vec__54761 = p__54757;
...
var G__54765 = new cljs.core.Keyword(null,"events","events",1792552201).cljs$core$IFn$_invoke$arity$1(task);
var G__54766 = now_seen_events;
var fexpr__54764 = new cljs.core.Keyword(null,"when","when",-576417306).cljs$core$IFn$_invoke$arity$1(task);
return (fexpr__54764.cljs$core$IFn$_invoke$arity$2 ? fexpr__54764.cljs$core$IFn$_invoke$arity$2(G__54765,G__54766) : fexpr__54764.call(null,G__54765,G__54766));
...
return cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2((function (index,p__54768){
...
var rule = map__54769__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54769__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var when = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54769__$1,new cljs.core.Keyword(null,"when","when",-576417306));
var events = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54769__$1,new cljs.core.Keyword(null,"events","events",1792552201));
var dispatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54769__$1,new cljs.core.Keyword(null,"dispatch","dispatch",1319337009));
var dispatch_n = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54769__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236));
var dispatch_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54769__$1,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614));
var halt_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54769__$1,new cljs.core.Keyword(null,"halt?","halt?",-1110658247));
...
var G__54771 = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"id","id",-1388402092),(function (){var or__4126__auto__ = id;
...
var G__54771__$1 = (cljs.core.truth_(dispatch_fn)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__54771,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614),dispatch_fn):G__54771);
if(cljs.core.not(dispatch_fn)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__54771__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236),(cljs.core.truth_(dispatch_n)?dispatch_n:(cljs.core.truth_(dispatch)?(new cljs.core.List(null,dispatch,null,(1),null)):cljs.core.List.EMPTY
)));
} else {
return G__54771__$1;
}
...
var map__54781 = rule;
var map__54781__$1 = (((((!((map__54781 == null))))?(((((map__54781.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__54781.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__54781):map__54781);
var dispatch_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54781__$1,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614));
var dispatch_n = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54781__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236));
 ...
 */
day8.re_frame.async_flow_fx.make_flow_event_handler = (function day8$re_frame$async_flow_fx$make_flow_event_handler(p__54783){
var map__54785 = p__54783;
...
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54785__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var db_path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54785__$1,new cljs.core.Keyword(null,"db-path","db-path",-68094099));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54785__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
var first_dispatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54785__$1,new cljs.core.Keyword(null,"first-dispatch","first-dispatch",128561923));
...
return (function day8$re_frame$async_flow_fx$make_flow_event_handler_$_async_flow_event_handler(p__54790,p__54791){
var map__54792 = p__54790;
var map__54792__$1 = (((((!((map__54792 == null))))?(((((map__54792.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__54792.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__54792):map__54792);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54792__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__54793 = p__54791;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54793,(0),null);
var event_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54793,(1),null);
var event_v = vec__54793;
var pred__54797 = cljs.core._EQ_;
var expr__54798 = event_type;
if(cljs.core.truth_((pred__54797.cljs$core$IFn$_invoke$arity$2 ? pred__54797.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"setup","setup",1987730512),expr__54798) : pred__54797.call(null,new cljs.core.Keyword(null,"setup","setup",1987730512),expr__54798)))){
...
var vec__54800 = event_v;
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54800,(0),null);
var forwarded_event = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54800,(1),null);
var map__54803 = get_state(db);
...
var seen_events = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54803__$1,new cljs.core.Keyword(null,"seen-events","seen-events",1607648392));
var rules_fired = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54803__$1,new cljs.core.Keyword(null,"rules-fired","rules-fired",-1669838140));
...
var vec__54806 = day8.re_frame.async_flow_fx.ensure_has_id(flow);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54806,(0),null);
var flow_SINGLEQUOTE_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54806,(1),null);
