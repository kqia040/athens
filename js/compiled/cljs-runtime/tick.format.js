...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__39448 = goog.object.get(JSJodaLocale,"Locale");
if((G__39448 == null)){
return null;
} else {
return goog.object.get(G__39448,"US");
}
}catch (e39447){if((e39447 instanceof Error)){
var e = e39447;
return null;
} else {
throw e39447;
