...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__42557_SHARP_){
return handle_mode(p1__42557_SHARP_,cljs.core.get.cljs$core$IFn$_invoke$arity$2(modes,p1__42557_SHARP_));
}),cljs.core.keys(modes));
} else {
if(cljs.core.vector_QMARK_(modes)){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__42558_SHARP_){
return handle_mode(cljs.core.first(p1__42558_SHARP_),cljs.core.second(p1__42558_SHARP_));
}),modes);
} else {
return null;
}
 ...
 */
stylefy.impl.conversion.convert_base_style_into_class = (function stylefy$impl$conversion$convert_base_style_into_class(p__42577,options){
var map__42582 = p__42577;
...
var style = map__42582__$1;
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42582__$1,new cljs.core.Keyword(null,"props","props",453281727));
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42582__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
var custom_selector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42582__$1,new cljs.core.Keyword(null,"custom-selector","custom-selector",-474556277));
 ...
 */
stylefy.impl.conversion.convert_media_queries = (function stylefy$impl$conversion$convert_media_queries(p__42600,options){
...
var style = map__42601__$1;
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42601__$1,new cljs.core.Keyword(null,"props","props",453281727));
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42601__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
var custom_selector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42601__$1,new cljs.core.Keyword(null,"custom-selector","custom-selector",-474556277));
 ...
 */
stylefy.impl.conversion.convert_supports_rules = (function stylefy$impl$conversion$convert_supports_rules(p__42612,options){
var map__42613 = p__42612;
var map__42613__$1 = (((((!((map__42613 == null))))?(((((map__42613.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__42613.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__42613):map__42613);
var style = map__42613__$1;
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42613__$1,new cljs.core.Keyword(null,"props","props",453281727));
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42613__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
var custom_selector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42613__$1,new cljs.core.Keyword(null,"custom-selector","custom-selector",-474556277));
 ...
 */
stylefy.impl.conversion.convert_manual_styles = (function stylefy$impl$conversion$convert_manual_styles(p__42641,options){
var map__42642 = p__42641;
var map__42642__$1 = (((((!((map__42642 == null))))?(((((map__42642.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__42642.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__42642):map__42642);
var style = map__42642__$1;
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42642__$1,new cljs.core.Keyword(null,"props","props",453281727));
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42642__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
var custom_selector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42642__$1,new cljs.core.Keyword(null,"custom-selector","custom-selector",-474556277));
...
var manual_selector_and_css_props = clojure.walk.walk((function (p1__42640_SHARP_){
if(cljs.core.map_QMARK_(p1__42640_SHARP_)){
return stylefy.impl.utils.remove_special_keywords(p1__42640_SHARP_);
} else {
return p1__42640_SHARP_;
}
...
(stylefy.impl.conversion.style__GT_css.cljs$core$IFn$_invoke$arity$2 = (function (p__42667,options){
...
var style = map__42668__$1;
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42668__$1,new cljs.core.Keyword(null,"props","props",453281727));
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42668__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
