...
var G__30037 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(n) : rewrite_clj.zip.next.call(null,n));
loc = G__30037;
continue;
} else {
var G__30038 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__30038;
continue;
}
} else {
var G__30039 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__30039;
continue;
}
}
...
var G__30027 = zloc;
var G__30028 = (function (){var G__30029 = zprint.rewrite.prewalk_subtree(p_QMARK_,f,(function (){var G__30030 = zloc;
var G__30030__$1 = (((G__30030 == null))?null:(rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1(G__30030) : rewrite_clj.zip.node.call(null,G__30030)));
if((G__30030__$1 == null)){
return null;
} else {
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__30030__$1) : zprint.zutil.edn_STAR_.call(null,G__30030__$1));
}
})());
return (rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1(G__30029) : rewrite_clj.zip.root.call(null,G__30029));
})();
return (rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2(G__30027,G__30028) : rewrite_clj.zip.replace.call(null,G__30027,G__30028));
});
/**
...
var G__30044 = (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.down.call(null,nloc));
nloc = G__30044;
continue;
}
break;
...
var G__30045 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.right.call(null,nloc));
var G__30046 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__30045;
out = G__30046;
continue;
} else {
...
var G__30049 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(replaced_loc) : rewrite_clj.zip.right.call(null,replaced_loc));
var G__30050 = cljs.core.next(new_loc);
var G__30051 = replaced_loc;
nloc = G__30049;
new_loc = G__30050;
last_loc = G__30051;
continue;
...
return zprint.rewrite.sort_val((function (){var G__30031 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(zloc) : rewrite_clj.zip.right.call(null,zloc));
return (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(G__30031) : rewrite_clj.zip.down.call(null,G__30031));
})());
});
/**
...
var new_dep = zprint.rewrite.prewalk(zloc,(function (p1__30032_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1(p1__30032_SHARP_) : rewrite_clj.zip.tag.call(null,p1__30032_SHARP_)),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1(p1__30032_SHARP_) : rewrite_clj.zip.sexpr.call(null,p1__30032_SHARP_)),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
